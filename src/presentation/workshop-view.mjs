...
export function createWorkshopView(root,{onCommand,onSave,onLoad,onFailure,onRecording,onInteraction,getCursor,guideSteps=[]}) {
 ...
 const meshes=new Map(),wires=new THREE.Group();scene.add(wires);const portCues=new THREE.Group();scene.add(portCues);let portCueKey='',previewEndpoint=null,socketPreview=null;
