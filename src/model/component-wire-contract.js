...
const PROPERTY_SCHEMAS = Object.freeze({
  ...
  maximumGaugePressurePa: { type: "number", exclusiveMinimum: 0 },
  referenceInternalVolumeM3: { type: "number", exclusiveMinimum: 0 },
  initialColdGaugePressurePa: { type: "number" },
  initialGasTemperatureK: { type: "number", exclusiveMinimum: 0 },
  gasToShellConductanceWPerK: { type: "number", minimum: 0 },
  maximumAbsolutePressurePa: { type: "number", exclusiveMinimum: 0 },
  burstAbsolutePressurePa: { type: "number", exclusiveMinimum: 0 },
  orificeAreaM2: { type: "number", exclusiveMinimum: 0 },
  ...
  responseTimeS: { type: "number", exclusiveMinimum: 0 },
  reliefAbsolutePressurePa: { type: "number", exclusiveMinimum: 0 },
  motorThermalMassJPerK: { type: "number", exclusiveMinimum: 0 },
  motorCoolingWPerK: { type: "number", minimum: 0 },
  maximumMotorTemperatureK: { type: "number", exclusiveMinimum: 0 },
  ...
  openingTimeS: { type: "number", exclusiveMinimum: 0 },
  commandDeadband: { type: "number", minimum: 0, exclusiveMaximum: 1 },
  leakageAreaM2: { type: "number", minimum: 0 },
  failPosition: { type: "number", minimum: -1, maximum: 1 },
