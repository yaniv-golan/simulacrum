...
function gearbox() {
  const b = new BlueprintBuilder("gearbox"),
    ...
    outputGear = b.add("gear24", [-0.715, 0.9, 0.82]),
    outputAxle = b.add("axle", [-0.715, 0.9, 0.82]),
    outputBearing = b.add("bearing", [-0.715, 0.9, 0.48]),
    sensor = b.add("sensor", [-0.715, 0.9, 1.14]),
