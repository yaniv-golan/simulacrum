...
test('UI feature breadth refuses future features',()=>{const m={milestone:'M3b',milestones:['M3b','M4']};assert.doesNotThrow(()=>checkBreadth({},m,{editor:{milestone:'M3b'}}));assert.throws(()=>checkBreadth({},m,{programming:{milestone:'M4'}}),/breadth/);});
