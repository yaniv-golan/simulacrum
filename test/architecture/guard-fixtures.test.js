...
const cases = [
  ...
  {
    name: "hand-written module under generated/ keeps origin analysis",
    files: {
      "model/generated/hand-written.js":
        "export const leak = () => document.querySelector('#x');",
    },
    expected: ["FORBIDDEN_PRESENTATION_API"],
  },
  {
    name: "nested hand-written module under generated/ keeps origin analysis",
    files: {
      "model/generated/deep/hand-written.js":
        "export const leak = () => localStorage.getItem('x');",
    },
    expected: ["BROWSER_STORAGE_BYPASS"],
  },
  {
    name: "generated banner exempts origin analysis without hiding imports",
    files: {
      "model/generated/wire-validators.js":
