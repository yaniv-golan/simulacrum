...
test('integration in wrong phase refuses',()=>assert.throws(()=>fixture((p,s)=>p.endsWith('session.mjs')?s.replace("case 'integration-contacts': world.step();","case 'controller-commands': world.step();"):s),/integration/));
