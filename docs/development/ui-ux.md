...
<!-- doc-review {"version":1,"fingerprint":"27a95ee5931c3870b33942e509cde3b50386c2eba64b13956df691b6e8327a96","dependencies":"docs/development/.reviews/ui-ux/current-surfaces-and-lifecycle.json","dependencyDigest":"4ba1e395996420a87bc0d7ad73e7466c9ede38d82cda391707ae9f24aad2a315","disposition":"updated","rationale":"The feedback utility-row explanation now specifies an always-reserved badge line and minimum button width. CSS no longer removes an empty badge from layout, while the in-flow row still wraps and allows readable longer recording errors. Offline recovery, consent, authored/UI-only context, reduced-motion behavior and separate human acceptance requirements are unchanged."} -->
...
parts without placing them. Feedback and recording controls occupy a separate utility row in the workshop layout.
...
<!-- doc-review {"version":1,"fingerprint":"d1463daab0834640223e9ea7855421efbc42672d0460e2ddeb2f20f344581395","dependencies":"docs/development/.reviews/ui-ux/verification-and-review.json","dependencyDigest":"5af833aa82a36d4bcdfa0cf6c7628dadf7658956afb88d559a01c631eee28b23","disposition":"still accurate","rationale":"The repaired playtesting explanation changes toolbar placement and context payload scope, while this section still requires rendered targeting, keyboard/cancellation/revisit evidence and new failing controls. Source/unit success is not browser completion, comprehension, satisfaction or F1; existing candidate tiers and participant protocols remain authoritative."} -->
