...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"9426ee0235440bfe91fe6f9c7a49a2102c93bc61842c8a8126b9e7bf409748f4","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"b3b5c73a297d3b38c008a79f54972005eb4e8d1a65bdc8fe945edc22c1800ca5","disposition":"still accurate","rationale":"Hosted-ready check waits (claude/hosted-check-waits on 458e9b3c, stacked on q44-release-reuse): scripts/manifest.json changed only in `hostProfiles.github-ubuntu-2cpu` (`waitScale`, `liveSliceMs`, `measurementRuns` = the first full-route nightly 34921754847) and in regenerated scope digests; milestone allocation, bars and gates are untouched."} -->
