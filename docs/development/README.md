...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"ce7d123fdba46ce440df904a9821065fc3fa9d3d27d30d3ecfe19d30f529d86b","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"9a91fa95b822d2a766dc110d59280215ae1df36faa731937ecdbee629788392b","disposition":"still accurate","rationale":"Decision 45-B on the frozen release-tooling tip (bed79d1a, main 9c4e08d0): `--when-quiet <maxWaitMs>` (scripts/when-quiet.mjs, a pre-capture poll of the same launch admission at the reach the tier's own selection policy gives the delta, outside the window, recorded under report.whenQuiet) and `--cause browser=@refusal` (candidate-after.mjs expands the parent's attested admission refusal into the browser phase cause). AGENTS.md's milestone allocation, gate and manifest ownership are untouched by the table row; status remains M3b with F1 pending."} -->
...
<!-- doc-review {"version":1,"fingerprint":"cb53b206d1d2ef1ce72abb2915ad348a42edda7437c05d6ddb9051446eb513f4","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"137c72bd075936091942f0d3503709c11860a34fd3612b56645bf1923d5ddd40","disposition":"still accurate","rationale":"Decision 45-B on the frozen release-tooling tip (bed79d1a, main 9c4e08d0): `--when-quiet <maxWaitMs>` (scripts/when-quiet.mjs, a pre-capture poll of the same launch admission at the reach the tier's own selection policy gives the delta, outside the window, recorded under report.whenQuiet) and `--cause browser=@refusal` (candidate-after.mjs expands the parent's attested admission refusal into the browser phase cause). The suite now attaches the admission refusal (reason, refused ids, suite report) to the browser phase failure and the tiers copy it onto the phase row (verify-browser-suite.mjs, verification-tiers.mjs); run-check exports SLEEP_GAP_MS and verification-window exports windowState for the poller. Selection, scope rows, admission policy, phases and what refused timing rows mean (not evaluated, never a pass) are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"e7def6d744fa03ca2341d91a0a9393a799979511fb83df725e8d448d3a29f23b","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"23473f47d6229a98db953e233d78c64de267a01fdf7bda0c0b66299031842874","disposition":"updated","rationale":"Decision 45-B on the frozen release-tooling tip (bed79d1a, main 9c4e08d0): `--when-quiet <maxWaitMs>` (scripts/when-quiet.mjs, a pre-capture poll of the same launch admission at the reach the tier's own selection policy gives the delta, outside the window, recorded under report.whenQuiet) and `--cause browser=@refusal` (candidate-after.mjs expands the parent's attested admission refusal into the browser phase cause). The retry section now documents both flags: what @refusal cites and refuses, what --when-quiet polls, records (class transitions capped at 64) and never touches, that an expired wait publishes an unattested failed report, and that a citation never waits."} -->
