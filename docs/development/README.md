...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"2de7c8488622ca7eabe57a69734f7e70a8344ffb10bcfb2fba406ad5ac84b5ed","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"878ddcebaad3ad24264a91744aeef91229bf7e76d327472406024e3bcea7b70b","disposition":"still accurate","rationale":"Unchanged prose. The milestone stays M3b. scripts/manifest.json moved by this candidate's elastic-cord invariant row and its rewritten guarantee sentence, by the merged parametric-gear integration's supported-spur-transmission controls and verify-remote-playtest metadata row, and by the sixteen consumerSourceHash digests this closure refreshed. docs/contracts/runtime-v1.md moved by the merged integration's save version 4 sentences and by this merge fixing the elastic cord section's own version claims to read version 4. No bar, no gate rule and no milestone allocation changed, so the M3b statement and the rule that the manifest owns allocation both still hold."} -->
