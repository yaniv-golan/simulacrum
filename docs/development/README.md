...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"fe434d1e64c0a81994038bdb7bed35a33133b9578c7628053a2ab991e858c8ac","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"379323fa1effc64d7fb955ccf1cc9bef4b982dae84983ac56e43fc7dd7553992","disposition":"still accurate","rationale":"The only changed dependency is scripts/manifest.json, and it moved in three read-domain ways plus provenance: the parts-catalog-discovery guarantee now names the Sound band the placing row reserves and the coordinates card that leaves with its fields, the gear-look-v2 connection-display-isolation guarantee and its added gear control rows arrived with the stacked integration, and the merged favourite-star control anchor stayed. Eight browserReviewMetadataScopes consumerSourceHash rows were regenerated and reviewed on this tip. No milestone or bar allocation, gate row, or rule/check ownership moved, which is exactly what this section reports, so the M3b statement and the rule that the manifest owns allocation both hold."} -->
...
<!-- doc-review {"version":1,"fingerprint":"537b799b3d98298258d04ff6798891600e52c2a94d17fc4676f84583fd886726","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"8d1fc5b968200fa0e1370c095ab882e593455a328cc95aa0ddd9fdd430deec3d","disposition":"still accurate","rationale":"The only changed dependency is scripts/manifest.json. No browserChecks row, environment, phase, host profile, witness or selection rule changed; the integration adds assertions inside existing check scripts (verify-parts-catalog, verify-spring-browser, verify-workbench-content) and two guarantee sentences. The eight metadata scope rows moved by consumerSourceHash alone, each accepted on this tip with its mover named (the example-row helpers in catalog-browser-actions.mjs, the picker in workbench-content.mjs and workshop-view.mjs, the gear body in part-mesh.mjs, the rewritten project-status dialog in remote-playtest.mjs), and the proposal reported zero blockers and no undeclared reaching check. Selection, phase scheduling, reaching-check and platform rules are therefore untouched."} -->
...
<!-- doc-review {"version":1,"fingerprint":"a3ce65b4efdb0282a70a4149147bf78b0dc911681476358866f837f071a7a011","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"054564f8f425e2bc37709f8fc58c7b3176c54413cd07871cbf6dc400acade21a","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and dependency sidecar matching neither parent. The dependencies this integration actually touched are scripts/manifest.json (two guarantee sentences, gear control rows, reviewed scope hashes) and scripts/catalog-browser-actions.mjs (new expandExample/expandExampleVariants browser helpers). Neither is completion evidence nor a rule about how it is captured: no tier, candidate capture, receipt, receipt-reuse, stacking or landing rule changed. This merge is itself the stacked-integration step the section prescribes, performed exactly as written."} -->
