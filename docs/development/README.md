...
<!-- doc-review {"version":1,"fingerprint":"c9f9d7a04191b1145227aab42c14f7be4897e7714b62b6754593f182f89bf10c","dependencies":"docs/development/.reviews/README/keep-explanations-current.json","dependencyDigest":"a48a186ccc3df5d4d1ee8993c5e0514109ddd13de3630f6d54a6a48a20786430","disposition":"still accurate","rationale":"Current check-documentation and review owners retain per-section semantic decisions, source/body dependency hashing, external-package/lock identity, single-writer publication and rejection of stale evidence. Load Cell expands runtime/compiler/native dependencies and therefore makes transitive explanations stale; the spring.10 pin is correctly an imported-package input, not a new review procedure. Three new browser roots require explicit scope review under the existing workflow. No docs checker, batch contract, branch-pair selection policy or reviewed-source exception was changed by this merge; the section already requires regeneration and new review after later edits. Revalidated after final thumbnail scheduling and spring witness closure: the new timer/DOM/cache owner and browser-only induction do not alter this section’s previously reviewed ownership, verification or evidence requirements."} -->
...
<!-- doc-review {"version":1,"fingerprint":"62545ddc8b6fa0e5af52294db0e029cb23e39a398377dfb81468d8de70be5f89","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"de7f0ac2cdeaa3ef3b9ab1c6359ffc9eebcf654f7e68fbfd0daa2263f1759d55","disposition":"updated","rationale":"Replaced the outdated causal description of shared-sensing exclusivity with its actual current verifier procedure: the contact journey stops wall-clock progression while arming both receivers, then inspects each fixed tick within the existing 2400-tick/20-second bounds. The previous timeout mechanism is not established by the new setup. Keep exclusivity, starter/actuator admission, all watchdogs, source-bound receipts and scope policy unchanged. Separately inspected all 29 scope deltas: only roots/consumer membership/closure hashes change, retaining main's remote-feedback and local-message contracts and every read/exclusion. Revalidated after final thumbnail scheduling and spring witness closure: the spring root is retained and thumbnail queue is statically reachable; no read scope or excluded runtime category is widened."} -->
...
<!-- doc-review {"version":1,"fingerprint":"7d11ab129ea5395e05143ea6e9c56a772af4ff1ca378c0eac729bd3aa313c9aa","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"7030794ec82091cd6226dd6a68e3eb8182d9ad83733fb4049753a85ca77336f9","disposition":"still accurate","rationale":"Candidate capture, dependency validation, exact source/index checks, origin comparison and same-candidate audited-unit resume owners are unchanged from main. The spring.10 artifact and added Load Cell source/check files become ordinary captured inputs with separately installed dependency identity; they do not allow old browser/native receipts to certify a changed merge. New browser root metadata requires readiness review before capture, as documented. Current priority/history hints remain scheduling-only, browser checks execute fresh, and cross-branch merge comparisons still require both tips/common base. Revalidated after final thumbnail scheduling and spring witness closure: the new timer/DOM/cache owner and browser-only induction do not alter this section’s previously reviewed ownership, verification or evidence requirements."} -->
