...
<!-- doc-review {"version":1,"fingerprint":"2bca85dd4907e1af3eca051070ecc7d887402cf0f8c2bf4fd9946cadc80d4575","dependencies":"docs/development/.reviews/README/developer-guide.json","dependencyDigest":"5c5d17189a7be568e6d7a032e2b4ef8c9bfc3556cfcee6397a20f481799fb3f9","disposition":"still accurate","rationale":"--stack stacked on the frozen chain (tooling-stack-flag merged with q44-release-reuse 434fe72c, base 458e9b3c): re-recorded after merging the chain (release-identity's source record, item 50's refused-row marking, feedback-sync, q44's release reuse) — Stacked candidates by --stack (tooling-stack-flag on main 458e9b3c): AGENTS.md gained the `merge --stack <ref>` table row and its Collaboration paragraph now names the flag in place of the three typed numbers; the guide's entry points, layer pointers and working loop are unchanged."} -->
...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"6840a53807141f4373f1ceadf99760f39f2781578508b64db5823a379e38aa29","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"c5694b263009457d2e1666392ad8fedf1fe3021f0299cf26728423f2b372ed8f","disposition":"still accurate","rationale":"--stack + item 52 stacked on claude/hosted-check-waits 94c85e92 (tooling-stack-flag, base 458e9b3c): re-recorded after merging webmcp's hosted-check-waits tip and folding item 52 (candidate-after requires a structural check under the gate's `structural:` receipt key; fixtures renamed) — --stack stacked on the frozen chain (tooling-stack-flag merged with q44-release-reuse 434fe72c, base 458e9b3c): re-recorded after merging the chain (release-identity's source record, item 50's refused-row marking, feedback-sync, q44's release reuse) — Stacked candidates by --stack (tooling-stack-flag on main 458e9b3c): AGENTS.md changed only in the verification table and the stacking paragraph; no milestone, bar or gate allocation changed."} -->
...
<!-- doc-review {"version":1,"fingerprint":"feab5c976f57c59adcb37de3e9b5c497cf69ab5b35f483199d0b152c8eea2d5e","dependencies":"docs/development/.reviews/README/verify-a-change.json","dependencyDigest":"aecf4b49c3d770f5cac52b532773f28015023980459a16a1e5ba0eebc0790153","disposition":"still accurate","rationale":"--stack + item 52 stacked on claude/hosted-check-waits 94c85e92 (tooling-stack-flag, base 458e9b3c): re-recorded after merging webmcp's hosted-check-waits tip and folding item 52 (candidate-after requires a structural check under the gate's `structural:` receipt key; fixtures renamed) — --stack stacked on the frozen chain (tooling-stack-flag merged with q44-release-reuse 434fe72c, base 458e9b3c): re-recorded after merging the chain (release-identity's source record, item 50's refused-row marking, feedback-sync, q44's release reuse) — Stacked candidates by --stack (tooling-stack-flag on main 458e9b3c): the stacked-integrations paragraph now documents `merge --stack <ref>` — destination = the named branch, incoming = the branch's pre-integration tip (linear-on-ref integrates whole with the ref as base), base = the unique merge-base, refusals by name (HEAD without the ref, HEAD is the ref, criss-cross, --stack main), `priority.chain`, the window intent and the printed landing order — with the long form kept. Verified against candidate-stack.mjs (deriveStack), verify-candidate.mjs (applyStack at both parse sites) and verification-tiers.mjs (parseCompletionArgs)."} -->
...
<!-- doc-review {"version":1,"fingerprint":"ed0d942d29b1134ec94fa0eb16cdd1d14378e43cb248e4f59fe441359192f32f","dependencies":"docs/development/.reviews/README/keep-explanations-current.json","dependencyDigest":"a422e27ebcee4f3bb34de54cb553a7ab3ab6d677ffad840b2ff863492c59817a","disposition":"still accurate","rationale":"Hosted-ready check waits (claude/hosted-check-waits on 458e9b3c, stacked on q44-release-reuse): the review workflow, batch format and the source-bound regeneration described here are unchanged; the stale flag comes from the regenerated reference discovery for the edited scripts, not from any change to the workflow."} -->
...
<!-- doc-review {"version":1,"fingerprint":"f8f7e597f924ca5607b05e39d9f9b5a4cc2bb9895a6ce26df45f0753e0cfb238","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"9c7ca84704d4c6fa24e82f432b309b8a18926c3b878ed9b1d3b2b68908a19928","disposition":"still accurate","rationale":"--stack + item 52 stacked on claude/hosted-check-waits 94c85e92 (tooling-stack-flag, base 458e9b3c): re-recorded after merging webmcp's hosted-check-waits tip and folding item 52 (candidate-after requires a structural check under the gate's `structural:` receipt key; fixtures renamed) — --stack stacked on the frozen chain (tooling-stack-flag merged with q44-release-reuse 434fe72c, base 458e9b3c): re-recorded after merging the chain (release-identity's source record, item 50's refused-row marking, feedback-sync, q44's release reuse) — Stacked candidates by --stack (tooling-stack-flag on main 458e9b3c): verification-tiers.mjs's parser accepts --stack for merge and verification-window.mjs's intent gained the `stack` field; browser scheduling, selection, admissions and the window protocol described here are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"ad11e537a2577a92b4b4038407acb3973f71e739fe38baa0782732b35df26065","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"e870dfba237526fe5cd85575abff714d29f083a08e5739d5a6ef7a9df8c9b9ea","disposition":"still accurate","rationale":"--stack + item 52 stacked on claude/hosted-check-waits 94c85e92 (tooling-stack-flag, base 458e9b3c): re-recorded after merging webmcp's hosted-check-waits tip and folding item 52 (candidate-after requires a structural check under the gate's `structural:` receipt key; fixtures renamed) — --stack stacked on the frozen chain (tooling-stack-flag merged with q44-release-reuse 434fe72c, base 458e9b3c): re-recorded after merging the chain (release-identity's source record, item 50's refused-row marking, feedback-sync, q44's release reuse) — Stacked candidates by --stack (tooling-stack-flag on main 458e9b3c): verify-candidate.mjs derives base/incoming/destination from --stack before the ordinary merge scope resolution (recorded in priority.chain; allowed with --after — a moved stack ref ends the retry chain by name — and with --satisfied-by, whose usage string names the flag); capture, dependency validation, resume, attestation and what a report certifies are unchanged; the stacking recipe itself lives in the verify-a-change section."} -->
