...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"f69ad04a131334c89c886ff72b2e30f46de0ff0e12891d7f4af9d47627b22826","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"f5e2ce810c52ba317a57adc3fc3a0116e83343be0889314b2af1b6227e5fcc4c","disposition":"still accurate","rationale":"Unchanged prose. scripts/manifest.json is the only changed dependency. Its delta is the supported-spur-transmission guarantee (now also stating that every corner closes the mesh and island energy ledgers with the damper and solver only removing energy, and separating steady transmission from transient dissipation), four positive-control anchors on test/gear-bounds.test.mjs of which one was renamed to stop claiming containment inside the endurance apparatus's mesh frequency, and one browserReviewMetadataScopes consumerSourceHash. The milestone field, every milestone allocation, every bar contract and every rule/check ownership row are byte-identical, so the M3b statement and the rule that the manifest owns allocation both still hold."} -->
...
<!-- doc-review {"version":1,"fingerprint":"eb5f045f00ee5afb8b6ef43c6d55d3063dd2ecc7816b86ae7d58d3ac488248be","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"67486847fcad4a69bac4c97f0f51d1d1959683e561963c12d865c1cebe464f5d","disposition":"still accurate","rationale":"Unchanged prose. This closure registers, removes and re-scopes no browser check: the measure-gears row keeps its id, script, exclusive execution, self environment, performance tier, timingSensitive and measures: physics facts, its ruleId and its 90000 ms timeout, and no other browserChecks row moved. The manifest delta is one invariant guarantee, four unit control anchors (one renamed) and one metadata consumerSourceHash whose closure input is scripts/measure-gears.mjs. Selection, phase scheduling, host profiles, registered platforms and the measured-scope rule are untouched. measure-gears now also records the per-phase energy ledger; measured at 47.9 s against the unchanged 90 s timeout, so no timing budget row was widened."} -->
...
<!-- doc-review {"version":1,"fingerprint":"8a93656483c476415b85d1e834543ea8df2974b1a48697a3a6c3e89f934ec785","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"e683c0d18d975df9d50cfba704dd665f4d394f8826f7ac27b01cc43482cbbec1","disposition":"still accurate","rationale":"Unchanged prose. The changed dependency is scripts/manifest.json, whose delta here is an invariant guarantee clause, four unit control anchors and one reviewed metadata consumerSourceHash. None of that is completion evidence or a rule about how evidence is captured: the tier set, candidate capture, candidate keys, receipts, receipt reuse and the stacking rule are unchanged. This slice records measurements and claims no tier."} -->
