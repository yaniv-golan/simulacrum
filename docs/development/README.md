...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"62179e6481d14ab01083bc84ca3883fca9d7d944caf01926f742964cf6727132","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"9ada824ccc34b1fc9a233e05d8a8d478b4fce6bc601c4378312d42a19961684a","disposition":"still accurate","rationale":"The only changed dependency is scripts/manifest.json, and the only read-domain change in it is the gear-look-v2 side of the connection-display-isolation invariant: guarantee sentences about the canonical solid envelope, a body drawn inward such as a gear's toothed disc, and the selection silhouette, plus that invariant's added gear control rows; the rest is regenerated scope metadata (eight browserReviewMetadataScopes consumerSourceHash rows from the reviewed scope apply). No milestone allocation, bar, gate row or rule/check ownership moved, which is what this section reports."} -->
...
<!-- doc-review {"version":1,"fingerprint":"5c5241d7e79505cf5e605062d0237f9185d6dd7f0009501fcfe7a3e24c20d3bd","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"7e3c06eba5f876bd0c0dc3607f42a20e64de49c6d88fe6e1b40f5dd2069e5af5","disposition":"still accurate","rationale":"The only changed dependency is scripts/manifest.json: the gear-look-v2 connection-display-isolation guarantee wording and its added gear control rows, plus eight regenerated browserReviewMetadataScopes consumerSourceHash rows. No browserChecks row, phase, host profile, selection rule or witness changed, and no scope declaration or read changed (the scope review recorded pure hash drift with no undeclared reaching checks), so selection, execution and scope review work exactly as described."} -->
...
<!-- doc-review {"version":1,"fingerprint":"8e042a1437ffeb8052209f80ca0e6e57507b72dbfed966451842693af6c03b00","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"826379a811b15b7b73bb0dee607319992604c50fd62db3fe32a0d5913ec5b102","disposition":"still accurate","rationale":"The only changed dependency is scripts/manifest.json: the gear-look-v2 connection-display-isolation guarantee wording, its added gear control rows and eight regenerated consumerSourceHash rows. No tier, candidate, stacking or landing rule changed; this merge is itself the stacked-integration step this section prescribes and nothing in the prescribed sequence moved."} -->
