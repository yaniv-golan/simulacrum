...
<!-- doc-review {"version":1,"fingerprint":"4c61fb5051f6a8105c6a4894d5de607c5786dffa71071f109757ed4460ea78d8","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"727ff665ec651303a326f1e2e393daddee1a4f00ee2f8296d0c43307eb66407b","disposition":"still accurate","rationale":"Follow-up to the diagnosed retry on main 38f6de8: refused-phase rows visible to --after, the every-commit format gate, the prettier fix. Browser selection, reaching-check scope rows, admission and the phased scheduler are unchanged; the suite failure now carries the ids of rows it refused (notEvaluated) beside the failed ids, which changes what a retry can see, not which checks a change selects or how a suite runs them."} -->
...
<!-- doc-review {"version":1,"fingerprint":"60adcc945ba502837a703979f42ec23fb1c2283b5d1b0ea52a389ed06694a14a","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"f3ac0b369e071517c379fa6f6fb9e87d4dd04464cbc89163bb14d9ba8fc7213f","disposition":"updated","rationale":"Follow-up to the diagnosed retry on main 38f6de8: refused-phase rows visible to --after, the every-commit format gate, the prettier fix. Added that rows a phase refused before they ran (timing rows under a refused admission, rows a sleeping host skipped) leave no receipt but are named on the phase row (notEvaluated) and count as unexecuted leaves beneath that phase: a cause on the phase covers them and the retry must observe each executed and passing. Verified against verify-browser-suite.mjs (error.notEvaluated), verification-tiers.mjs (row.notEvaluated) and candidate-after.mjs (classifyParentLeaves/validateCauses)."} -->
