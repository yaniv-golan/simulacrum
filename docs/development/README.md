...
<!-- doc-review {"version":1,"fingerprint":"5761f51db1f8eaed5613256166c11c31b15c6bef39e936f2e2a0b4db0fcb758f","dependencies":"docs/development/.reviews/README/verify-a-change.json","dependencyDigest":"6506a39550dbeefb5d15804e48bb7e2d42a3c797aa47a07d4f513118b4b827b0","disposition":"still accurate","rationale":"Hosted profile (claude/hosted-profile) stacked on the live-wait branch tooling-niced-launch-liveness 3a50c9e (both on main 421a2b1): the merge combined the two receipts of this section (marker from one side, sidecar from the other), which is why the receipt reads malformed; the prose is byte-identical on both branches. runtime-preflight.mjs gained assertUnnicedLaunch (a launch precondition documented in the candidate section) and host-profile.mjs makes the tiers refuse under SIMULACRUM_HOST_PROFILE before any write; the commands this section names, their order, the Node engine range and what each tier verifies are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"32284113d7b22d66b5889e465183fd93b63614d2ef480c8d694b78f88328de5f","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"5e0d516c1ab233577dd2c160e3ec9d6305c714f3d452eeea298645badeda9268","disposition":"still accurate","rationale":"Hosted profile (claude/hosted-profile) stacked on the live-wait branch tooling-niced-launch-liveness 3a50c9e (both on main 421a2b1): verify-browser-suite now carries both changes side by side — the derived-workers route records launch niceness and refuses a niced launch, the timing admission tracks the load decay (live-wait side), and the no-tier-context route applies the profile's two workers, registered or measurement budgets and the performance/timing-sensitive NOT_EVALUATED partition (hosted side); verification-run, ci.mjs, verification-tiers and validate-manifest changes are the hosted-profile deadlines, budget, refusal and hostProfiles validation already described in the profile paragraph, and the 'unconditional timing execution' sentence describes the no-tier-context route without a profile (scope witnesses), which the profile paragraph overrides for the scheduled hosted run. Scope rows regenerated by browser:scopes prepare show 0 changed scopes; registry rows, selection and witness policy are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"2e260de90b5db38686f9f3a3a39aad90fc50fa7f4c76d55b2d7be18b32aaa8f6","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"d839a5e96190aaeb1c76ec10813ba6fc62396f9b22320e120572f6c77a60b8eb","disposition":"still accurate","rationale":"Hosted profile (claude/hosted-profile) stacked on the live-wait branch tooling-niced-launch-liveness 3a50c9e (both on main 421a2b1): verify-candidate.mjs now performs both preflights — assertUnnicedLaunch records the launch niceness (live-wait side, launch recipe already in this section) and assertNoHostProfile refuses a hosted profile before any capture or report write (hosted side); verification-tiers refuses likewise; host-profile.mjs and validate-manifest own the profile's deadlines and validation. Capture, dependency validation, source binding, drift rejection and the tier commands are as reviewed."} -->
