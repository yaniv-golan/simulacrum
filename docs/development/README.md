...
<!-- doc-review {"version":1,"fingerprint":"ec693fa8c1f41429f12eb1ec37499a018fa6c06310c5089341402d15890712eb","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"42ca8e870784308ce41af54eeaae8f8b64a753468e6bd3b6a14b815ea7ec3a7a","disposition":"still accurate","rationale":"Unchanged prose. The changed dependency is scripts/manifest.json, whose delta here is an invariant guarantee clause, four unit control anchors and one reviewed metadata consumerSourceHash. None of that is completion evidence or a rule about how evidence is captured: the tier set, candidate capture, candidate keys, receipts, receipt reuse and the stacking rule are unchanged. This slice records measurements and claims no tier."} -->
