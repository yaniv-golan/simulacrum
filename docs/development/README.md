...
<!-- doc-review {"version":1,"fingerprint":"9db680338b5e0e2ce08661097b844f266e470c1c7b89241f3929045aa3618d79","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"14fa6384921b25ab8ef046fbd479a039bed7ac7429fcd752b2746a29c29596b4","disposition":"still accurate","rationale":"Item 50 on main 458e9b3c: an admission-refused timing row is now recorded on its run row at the refusal site and named on the browser phase failure, so a diagnosed retry can complete it. Selection, scope rows, admission, the phased scheduler and what the section says about refused timing rows (not evaluated, never a pass, never retried inside the tier) are unchanged; the change only makes the refusal visible to the phase row and to --after, which the isolated-candidate-completion section already describes. Verified against verify-browser-suite.mjs (refusal site and browserSuiteFailure)."} -->
