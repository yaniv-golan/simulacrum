...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"8543dc27bfa0fc46b9bc1632048ec8639e6eb2a6917a5ce834ff041e54172060","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"01f5abe3ec5106cc1ff5a07efc32d86154e6d524c4e594b77f6c3148a47c40d0","disposition":"still accurate","rationale":"Unchanged prose. Against the state this section was last reviewed in, scripts/manifest.json changed in exactly two keys: invariants gained elastic-cord and supported-spur-transmission's guarantee, owners and controls moved (the union of candidate 2's mount-repair sentence with this branch's bounds, energy-ledger and dissipation clauses, meshSpacingRepair now owned by src/model/gear-mesh.mjs, four test/gear-bounds.test.mjs controls and candidate 2's mis-spaced-mesh control added), and sixteen browserReviewMetadataScopes rows changed only consumerSourceHash. docs/contracts/runtime-v1.md gained the cord section and its save-version repair. The milestone field is still M3b, every milestone allocation, bar contract and rule/check ownership row is byte-identical, and no browserChecks row changed at all, so the M3b statement and the rule that the manifest owns allocation both still hold. The cord is an ordinary catalog entry and the gear bounds are evidence for an existing invariant, not new milestone breadth."} -->
...
<!-- doc-review {"version":1,"fingerprint":"8724de6d395d2b4c8960221d004426a847b58f0ab60e9be1df648dd2004cff03","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"f1715a0223b1b69c4f0c3c374219567420dadaea75a2c6f9d84e65b23eed37c2","disposition":"still accurate","rationale":"Unchanged prose. This closure registers, removes and re-scopes no browser check: every browserChecks row is byte-identical, and measure-gears keeps its id, script, exclusive execution, self environment, performance tier, timingSensitive and measures: physics facts, its ruleId and its 90000 ms timeout, so no timing budget row was widened. Sixteen browserReviewMetadataScopes rows changed only consumerSourceHash. Fifteen were re-recorded by candidate 2 for the cord entering src/model/blueprint.schema.json, the generated validator and types, src/model/tick.mjs and src/model/cord.mjs, and for meshSpacingRepair moving from src/model/gear-geometry.mjs to src/model/gear-mesh.mjs inside the same hashed closures. The sixteenth, metadata:scripts/source-identity.mjs, was reviewed and applied in this closure because scripts/measure-gears.mjs gained measureGearBounds, its test/fixtures/gear-bounds.mjs imports and the per-phase mesh and island ledger recording; that row's entrypoint, sourceSha256, reads, purposes, both excluded inputs, dependencies, consumers and checks are unchanged, and its affected-but-not-witnessed checks are enumerated NOT_EXECUTED rather than claimed. No browser entrypoint was added, and selection, phase scheduling, host profiles, registered platforms and the measured-scope rule are untouched."} -->
...
<!-- doc-review {"version":1,"fingerprint":"f3b481f1eff4478bb652d56e5be37eec6f966937035ce4e12116868001200674","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"726ca837b8ff46e2feaa58358a614bcf6642f511a946a9f65418e88f206e3b49","disposition":"still accurate","rationale":"Unchanged prose. Nothing about tiers, candidate capture, candidate keys, receipts, receipt reuse, attestation, stacking or landing changed: no file under scripts/candidate*.mjs, scripts/verification-*.mjs, scripts/verify-*.mjs or scripts/land.mjs moved in this closure. The movers are candidate 2's cord model, blueprint schema and generated validator, the relocation of the gear mesh repair into src/model/gear-mesh.mjs, this branch's gear bound measurements and fixtures, and sixteen re-recorded metadata consumerSourceHash values; all are ordinary selection inputs this section already describes. Candidate evidence still applies only to its recorded bytes, which is why this stacked integration carries no tier receipt of its own: it merges the earlier parametric-gear-2 integration branch and will verify with merge --stack, exactly as this section and the stacking rule require."} -->
