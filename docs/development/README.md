...
<!-- doc-review {"version":1,"fingerprint":"10b39175a6e0c748c49e87f752a8cbe22607dbc392f851a263609d62bd74d081","dependencies":"docs/development/.reviews/README/developer-guide.json","dependencyDigest":"4e4093f1fe8f8c4c86df5f55c0d5e3932aa69990c296c4036822779ffbd9c28b","disposition":"still accurate","rationale":"Tooling candidate land-script (guarded landing, version-field digest exclusion, stall evidence; pre-integration base 458e9b3): AGENTS.md changed one sentence: the landing is done through `npm run land` instead of a hand check of priority.destination; the guide's entry points are unchanged."} -->
...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"246ad435d6179bbe6288e8e19dccdafff63e68681918b1d6c5a22fac52475664","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"ab122150717e269b0f4caab5d212e3f557e42714b6908b1dc52a1846a8af6b49","disposition":"still accurate","rationale":"Tooling candidate land-script (guarded landing, version-field digest exclusion, stall evidence; pre-integration base 458e9b3): the manifest gained the landing-integrity invariant and two watchdog controls under bounded-process-ownership; milestones and bars are unchanged; AGENTS.md changed only the landing sentence."} -->
...
<!-- doc-review {"version":1,"fingerprint":"888cca8681c4fbce0b6cf69fa605edf7b9fd43049c23e2c58135a2242892f925","dependencies":"docs/development/.reviews/README/verify-a-change.json","dependencyDigest":"1bf5f34b1ca9bb11dba1f4187002b237a3e3fa777e9182cd4bc046d5b65a74c0","disposition":"updated","rationale":"Tooling candidate land-script (guarded landing, version-field digest exclusion, stall evidence; pre-integration base 458e9b3): the section now documents `npm run land` (scripts/land.mjs: attested passing merge report for the tip, integrated against the current main, bytes and modes equal, fast-forward) and the `?? priority.base` rule; candidate-after.mjs is imported for verifyAttestation; package.json/package-lock.json appear changed because implicit external-package coverage now digests them without their version fields (a one-time re-key of every sidecar); dependency ranges and the lockfile's resolved versions are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"b6128d805f08aadd48e617a2d38379992feb64beb2db7025e0b8a81d26da8e9d","dependencies":"docs/development/.reviews/README/keep-explanations-current.json","dependencyDigest":"aff4a6d13cb0da39b4aee6af64aa7fff34b7ddc5e138803ae89f9464e15d3476","disposition":"updated","rationale":"Tooling candidate land-script (guarded landing, version-field digest exclusion, stall evidence; pre-integration base 458e9b3): the coverage paragraph now says the package's own version is excluded from implicit external-package coverage; scripts/documentation.mjs implements exactly that; package.json/package-lock.json appear changed because implicit external-package coverage now digests them without their version fields (a one-time re-key of every sidecar); dependency ranges and the lockfile's resolved versions are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"70630cedefdae907af0ae613e8c2edb92a542d342e34c118b4c8673ffa7dc780","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"877e955fd96da6d472b32b729a7aa8b899d26a11981e7ab9e4a655fc99b64140","disposition":"updated","rationale":"Tooling candidate land-script (guarded landing, version-field digest exclusion, stall evidence; pre-integration base 458e9b3): the failed-row diagnostics sentence now lists the Linux wait channel, paging counters with memoryAtStart, the bounded macOS stack sample and the memoryMs/sampleMs costs; verify-cloud-runtime's manifest timeoutMs is 90 s; run-check.mjs and process-inventory.mjs gained watchdog evidence only (paging counters, Linux wait channels, one bounded stack sample on macOS); deadlines, termination and outcomes are unchanged; package.json/package-lock.json appear changed because implicit external-package coverage now digests them without their version fields (a one-time re-key of every sidecar); dependency ranges and the lockfile's resolved versions are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"a692928cfb9349989adc44995cade52fbffe574b58a429c3f56a7c9025b49989","dependencies":"docs/development/.reviews/README/shared-verification-window.json","dependencyDigest":"2b4ac0f872d771c8f7637ef0c846b1370f7f18a31387acf2690e021a299563d0","disposition":"still accurate","rationale":"Tooling candidate land-script (guarded landing, version-field digest exclusion, stall evidence; pre-integration base 458e9b3): run-check.mjs and process-inventory.mjs gained watchdog evidence only (paging counters, Linux wait channels, one bounded stack sample on macOS); deadlines, termination and outcomes are unchanged; window ownership is unchanged; package.json/package-lock.json appear changed because implicit external-package coverage now digests them without their version fields (a one-time re-key of every sidecar); dependency ranges and the lockfile's resolved versions are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"619deca8c32941bff743f6406811a3d81e3b72663c973cd52d35fd51bdd21ae4","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"fabacd788e760692644c2ce55fbd532a145c68782129caa63169a643be17c5d2","disposition":"still accurate","rationale":"Tooling candidate land-script (guarded landing, version-field digest exclusion, stall evidence; pre-integration base 458e9b3): the manifest adds the landing-integrity invariant and watchdog controls; documentation.mjs changed the package digest; run-check.mjs and process-inventory.mjs gained watchdog evidence only (paging counters, Linux wait channels, one bounded stack sample on macOS); deadlines, termination and outcomes are unchanged; candidate capture and tiers are unchanged; package.json/package-lock.json appear changed because implicit external-package coverage now digests them without their version fields (a one-time re-key of every sidecar); dependency ranges and the lockfile's resolved versions are unchanged."} -->
