...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"fcc7488fd04cca6fd4e11fa4915b76676a113f3b90fbff71d7cb6d7048eb74d9","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"7e3a1209a8e9ecb4443a07d5265f62695015aace0decc18bd008ed4ac25126e1","disposition":"still accurate","rationale":"scripts/manifest.json changed only by the release identity record (identityFiles export in candidate.mjs sharing the candidate inventory; prepare-release recording files, installed digest, installedAt and runtime identity in source.json with caches redirected and the digest re-verified after the tier; its control registered under release-verification-single-pass); milestone allocation still declares M3b with F1 pending and the same incomplete qualifications, and the manifest and gate remain the owners named here."} -->
...
<!-- doc-review {"version":1,"fingerprint":"6b7bca365e0e2d69355019d07f225ed6887501919274f5c4c2722ac16a5f1dd4","dependencies":"docs/development/.reviews/README/verify-a-change.json","dependencyDigest":"4e20360ca40321f1652f0b82e098ba9ed2d96c57e3c5b73fac79922829ae4c44","disposition":"still accurate","rationale":"playtesting.md#release-operations gained one sentence describing the release identity record (identityFiles export in candidate.mjs sharing the candidate inventory; prepare-release recording files, installed digest, installedAt and runtime identity in source.json with caches redirected and the digest re-verified after the tier; its control registered under release-verification-single-pass); the tiers, commands, exit codes and evidence rules this section describes are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"1f87e0534431473417ff934e3f9224a9ff384e452a1b38d3e5f93bb08762141e","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"eeb694f3800faf4bd83a2db46f0fcd7cb5058024cd057b031721109a272aadf8","disposition":"still accurate","rationale":"scripts/candidate.mjs gained the pure identityFiles export (the inventory files map already used by candidateIdentity) and the manifest a test control for the release identity record (identityFiles export in candidate.mjs sharing the candidate inventory; prepare-release recording files, installed digest, installedAt and runtime identity in source.json with caches redirected and the digest re-verified after the tier; its control registered under release-verification-single-pass); browser scheduling, selection, admission and scope handling are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"ece962ba4ffd90dd2968a047a65ce078bb6ec8efabd3d7e9133d4125312c895d","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"e7173ac38042522c7b9bbbaddb8a4cf3ec97b5f77a536fea438c08864caa84e9","disposition":"still accurate","rationale":"candidate capture, identity comparison and completion tiers are unchanged; scripts/candidate.mjs only exports identityFiles (the same inventory files map) so release preparation can record the release identity record (identityFiles export in candidate.mjs sharing the candidate inventory; prepare-release recording files, installed digest, installedAt and runtime identity in source.json with caches redirected and the digest re-verified after the tier; its control registered under release-verification-single-pass) for a later merge citation, and the manifest registers that record's control."} -->
