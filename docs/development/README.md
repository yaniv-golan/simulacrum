...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"257ecfbc51f70e50097cd40685813864e80c63f53ad783bc2a6e5c874a658f2e","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"a551a92f883c68d12764bf93c9e4d3c234874918a4fdbd67021ad96b3147b6c5","disposition":"still accurate","rationale":"Unchanged prose. scripts/manifest.json is the only changed dependency and it moved in three places: the supported-spur-transmission guarantee gained a clause about what one constant mesh stiffness delivers across the authored teeth and module bounds, four positive-control anchors on test/gear-bounds.test.mjs were added to the same invariant, and one browserReviewMetadataScopes consumerSourceHash was refreshed because scripts/measure-gears.mjs gained a measureGearBounds section. The milestone field, every milestone allocation, every bar contract and every rule/check ownership row are byte-identical, so the M3b statement and the rule that the manifest owns allocation both still hold."} -->
...
<!-- doc-review {"version":1,"fingerprint":"12935a1fd63f5eb3bf887047cdb6da54331de889b8bbf755148ffca7f6fdb305","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"b07d9848f5df64951d27039d8f2540064a70437a4da1ec811efa3928893ff4dd","disposition":"still accurate","rationale":"Unchanged prose. This closure registers, removes and re-scopes no browser check: the measure-gears row keeps its id, script, exclusive execution, self environment, performance tier, timingSensitive and measures: physics facts, its ruleId and its 90000 ms timeout, and no other browserChecks row moved. The manifest delta is one invariant guarantee, four unit control anchors and one metadata consumerSourceHash accepted with a per-row rationale naming scripts/measure-gears.mjs as the closure input that actually moved. Selection, phase scheduling, host profiles, registered platforms and the measured-scope rule are untouched, which is what this section prescribes. The added measurement lengthened measure-gears from roughly 44 s to a measured 48.8 s against that unchanged 90 s timeout, so no timing budget row was widened."} -->
...
<!-- doc-review {"version":1,"fingerprint":"170c23b5ddadd8e8f54179bd8780db7647794a724cf441104a15670ff54c8acb","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"a556bcb38ba059b98708222773711c0d9fcb6d5a4dc4c1cdea5d57792c0a57b1","disposition":"still accurate","rationale":"Unchanged prose. The changed dependency is scripts/manifest.json, whose delta here is an invariant guarantee clause, four unit control anchors and one reviewed metadata consumerSourceHash. None of that is completion evidence or a rule about how evidence is captured: the tier set, candidate capture, candidate keys, receipts, receipt reuse and the stacking rule are all unchanged, and this slice records measurements without claiming any tier."} -->
