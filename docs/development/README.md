...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"4cc62cf8a3aaf1cf4535820aec2cd801a0ae470456d4eb78f7c6bb4bcaa116a6","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"4a58b5a2cbc96c459afa1b0f0ce75e2a39194dc9ee8b8937c42c128f40552c58","disposition":"still accurate","rationale":"AGENTS.md gained the release citation clause and the manifest extended the release-verification-single-pass guarantee and controls (the release evidence-reuse change: prepare-release.mjs accepts --after <merge attempt report>, admits the parent through its attestation and signed resume descriptor, requires a byte-identical tree, installed-dependency digest and relevant environment, runs the tier with a resume ledger (caches redirected, the identity record's installed digest re-checked after the tier), copies every cited receipt's evidence into the frozen tree and names each in the envelope; package-verification.mjs assertReusedEvidence admits a 'passed with reused receipts' package only to a bypass-expensive release, refuses it for qualified, CI, rollback-of-qualified and recovery paths; release.mjs passes --after for prepare only and lists reused receipts in the exception record and deploy summary; verification-resume.mjs exports verifyLeafRow/readLeafRow used by the ledger loader; verification-environment.mjs adds the fixture knobs PARENT_ATTEMPT, PARENT_REPORT and PURGED to the test-owned exemption group; the manifest guarantee for release-verification-single-pass names the citation and registers both new tests as positive and negative controls); milestone allocation, bars, gates and the recorded milestone state are unchanged, and the citation never advances a milestone."} -->
...
<!-- doc-review {"version":1,"fingerprint":"1c4abe19aac362d7527dc9930b71d5025bd9d9f107265839363684f26d31f672","dependencies":"docs/development/.reviews/README/verify-a-change.json","dependencyDigest":"f50e6de5754ff6768c8bf311a6dc52518fecc26209e9ac26b77216279afd6888","disposition":"updated","rationale":"Added one sentence that an experimental release may cite a byte-identical merge candidate's receipts only through the named release admission, pointing at playtesting.md#release-operations (the release evidence-reuse change: prepare-release.mjs accepts --after <merge attempt report>, admits the parent through its attestation and signed resume descriptor, requires a byte-identical tree, installed-dependency digest and relevant environment, runs the tier with a resume ledger (caches redirected, the identity record's installed digest re-checked after the tier), copies every cited receipt's evidence into the frozen tree and names each in the envelope; package-verification.mjs assertReusedEvidence admits a 'passed with reused receipts' package only to a bypass-expensive release, refuses it for qualified, CI, rollback-of-qualified and recovery paths; release.mjs passes --after for prepare only and lists reused receipts in the exception record and deploy summary; verification-resume.mjs exports verifyLeafRow/readLeafRow used by the ledger loader; verification-environment.mjs adds the fixture knobs PARENT_ATTEMPT, PARENT_REPORT and PURGED to the test-owned exemption group; the manifest guarantee for release-verification-single-pass names the citation and registers both new tests as positive and negative controls); the tiers, commands, exit codes and evidence rules this section describes are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"d19c9508b1386775579d4ec65dee8e1fe877bf0a26aedab3919ea918036c324a","dependencies":"docs/development/.reviews/README/keep-explanations-current.json","dependencyDigest":"a422e27ebcee4f3bb34de54cb553a7ab3ab6d677ffad840b2ff863492c59817a","disposition":"still accurate","rationale":"docs/development/reference.md was regenerated for the new feedback-sync-read-only invariant row from the feedback sync landing (scripts/playtest/sync-feedback.mjs: a scheduled read-only local copy of hosted feedback with attachments and referenced recording exports; manifest gained the feedback-sync-read-only invariant with its controls and regenerated consumer lists for download.mjs and cloud-store.mjs; reference.md regenerated; the in-memory CaptureStore fixture moved to test/fixtures/capture-store-memory.mjs); the documentation workflow (prepare, review, check, sidecars, batch decisions) is unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"d972240131b86bd81e27d58cd887b3377de2a866674cf2d88dd4b970ebb8c84f","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"7bc7b752ee8ca29c6b4739aba81af053ddbe0ed6d22e848f2fa8e32074cca711","disposition":"still accurate","rationale":"scripts/verification-environment.mjs added PARENT_ATTEMPT, PARENT_REPORT and PURGED to the test-owned knob exemption group, scripts/verification-resume.mjs gained the verifyLeafRow/readLeafRow exports and the manifest extended one release guarantee (the release evidence-reuse change: prepare-release.mjs accepts --after <merge attempt report>, admits the parent through its attestation and signed resume descriptor, requires a byte-identical tree, installed-dependency digest and relevant environment, runs the tier with a resume ledger (caches redirected, the identity record's installed digest re-checked after the tier), copies every cited receipt's evidence into the frozen tree and names each in the envelope; package-verification.mjs assertReusedEvidence admits a 'passed with reused receipts' package only to a bypass-expensive release, refuses it for qualified, CI, rollback-of-qualified and recovery paths; release.mjs passes --after for prepare only and lists reused receipts in the exception record and deploy summary; verification-resume.mjs exports verifyLeafRow/readLeafRow used by the ledger loader; verification-environment.mjs adds the fixture knobs PARENT_ATTEMPT, PARENT_REPORT and PURGED to the test-owned exemption group; the manifest guarantee for release-verification-single-pass names the citation and registers both new tests as positive and negative controls); browser scheduling, selection, admission and scope handling described here are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"54402691b7db85b5ae258f4059d6806b7d8c027ca901627da4f33367994b1cbd","dependencies":"docs/development/.reviews/README/shared-verification-window.json","dependencyDigest":"1fecb1f4b5e31cb6560d82c40ab70004115b6b40ebc4cb0b5872fbdef80ebf8f","disposition":"still accurate","rationale":"README#verify-a-change gained the release citation sentence (the release evidence-reuse change: prepare-release.mjs accepts --after <merge attempt report>, admits the parent through its attestation and signed resume descriptor, requires a byte-identical tree, installed-dependency digest and relevant environment, runs the tier with a resume ledger (caches redirected, the identity record's installed digest re-checked after the tier), copies every cited receipt's evidence into the frozen tree and names each in the envelope; package-verification.mjs assertReusedEvidence admits a 'passed with reused receipts' package only to a bypass-expensive release, refuses it for qualified, CI, rollback-of-qualified and recovery paths; release.mjs passes --after for prepare only and lists reused receipts in the exception record and deploy summary; verification-resume.mjs exports verifyLeafRow/readLeafRow used by the ledger loader; verification-environment.mjs adds the fixture knobs PARENT_ATTEMPT, PARENT_REPORT and PURGED to the test-owned exemption group; the manifest guarantee for release-verification-single-pass names the citation and registers both new tests as positive and negative controls); window acquisition, admission, timing pressure and recovery described here are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"2720381796b9c4ac166e701636ea1334f61956361ba067d81a88662d43acaf14","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"a693edbd6be0f6e5abb63ef1006d243a640ad89795c181ed59271d709321d191","disposition":"updated","rationale":"Amended the sentence that final refuses --after to name the one admission, an experimental release's release:prepare -- … --after, with a link to release operations (the release evidence-reuse change: prepare-release.mjs accepts --after <merge attempt report>, admits the parent through its attestation and signed resume descriptor, requires a byte-identical tree, installed-dependency digest and relevant environment, runs the tier with a resume ledger (caches redirected, the identity record's installed digest re-checked after the tier), copies every cited receipt's evidence into the frozen tree and names each in the envelope; package-verification.mjs assertReusedEvidence admits a 'passed with reused receipts' package only to a bypass-expensive release, refuses it for qualified, CI, rollback-of-qualified and recovery paths; release.mjs passes --after for prepare only and lists reused receipts in the exception record and deploy summary; verification-resume.mjs exports verifyLeafRow/readLeafRow used by the ledger loader; verification-environment.mjs adds the fixture knobs PARENT_ATTEMPT, PARENT_REPORT and PURGED to the test-owned exemption group; the manifest guarantee for release-verification-single-pass names the citation and registers both new tests as positive and negative controls); candidate capture, identity comparison, receipt reuse between candidates and the release-final citation are unchanged."} -->
