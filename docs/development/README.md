...
<!-- doc-review {"version":1,"fingerprint":"97046d7b6ab8d8f7763bc87855eed01068ec80e56bfabe0baabdf2a951a7d048","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"00e9a6688149ae8da592eb6a13a2abff85d7e4a015be1c736f3306f62e5ce9f2","disposition":"updated","rationale":"Read the complete section against current browser execution, scope and evidence owners. loadAndWait now waits within the existing page deadline for a callable command probe before reading the prior sequence or uploading a save, then retains the fresh sequence, exact save and expected result assertions. Served-build metadata still establishes source identity, not workshop or decoded-thumbnail readiness. Direct-edit separately waits for decoded palette images and retains its original count/image assertions and full manipulation journey. Scope review, shared-window admission, execution budgets, exclusivity and completion tiers remain unchanged. The existing shared-sensing description still matches its stopped-clock setup and fixed-tick sampling; its bounds and receiver assertions are retained. The combined helper also retains current main uploadWorkshopFile: it reads the admitted workshop only after command readiness, uploads through the first file input and explicitly accepts the protected full-workshop replacement prompt. Fresh receipt validation follows confirmation. The positive fake supplies the same empty-flat snapshot and locator interface; the existing scene-only confirmation and stale/rejected receipt controls remain."} -->
