...
## Milestone status
<!-- doc-review {"version":1,"fingerprint":"2348c83e1990a6252e593ed7c924ef4297c5ad08a1d9dc985698acec1aaba3f5","dependencies":"docs/development/.reviews/README/milestone-status.json","dependencyDigest":"11fdd195dc013921f5cb366544c36f1e1646c53836a4d1156cbd38c96cdc3280","disposition":"still accurate","rationale":"Unchanged prose; this section was not revised, so the disposition is still accurate rather than updated. docs/contracts/runtime-v1.md is the only changed dependency. The merged parametric-gear integration bumped the blueprint save version to 4 at the envelope, time-scale and slide sentences but left two sentences in Saves and checkpoints reading version 3, so the contract contradicted itself. This closure repairs those two: the checkpoint sentence now separates the session checkpoint version, which remains 3 as captureAnchor in src/simulation/session.mjs still writes it, from the blueprint save version 4, and the environment-admission sentence now reads version 4. The elastic cord energy paragraph also gained the scope of its row ledger. The milestone stays M3b and no bar, gate rule or milestone allocation moved, so the M3b statement and the rule that the manifest owns allocation both still hold. Correcting a version number the merge left inconsistent changes no milestone fact this section states."} -->
...
<!-- doc-review {"version":1,"fingerprint":"f17dabb7c16f96cb81937c91934e2b4199f39c0febb0021180c1f2dbec795fa2","dependencies":"docs/development/.reviews/README/keep-explanations-current.json","dependencyDigest":"45e977041aec312c9cce03443aa11001c3eabdca8227f9f38793740787274c36","disposition":"still accurate","rationale":"Unchanged prose. The one changed dependency is docs/development/reference.md, the generated discovery this section tells the reader to regenerate; docs:prepare regenerated it for the merged gear-geometry and parameter-input owners alongside the cord model. The prepare, review and check workflow, its ownership rules and the marker and sidecar records it prescribes are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"633496defc85db2413bd6fb460fca36c860bc810a3289d4a7c02384c12935ca0","dependencies":"docs/development/.reviews/README/browser-execution-and-scope.json","dependencyDigest":"5ed675de5a273364934ccfd5cf87aa29f83c6860d10cac0e0356fb010769a16f","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. This closure registers, removes and re-scopes no browser check: the only manifest delta is sixteen metadata scope rows whose consumerSourceHash was accepted with a per-row rationale naming that row's exact changed closure inputs. The other movers this section depends on are the merged integration's src/model/gear-geometry.mjs, catalog.mjs, geometry.mjs, environment.mjs and boundaries.d.ts, src/model/blueprint.schema.json, and the regenerated src/model/generated/blueprint-types.d.ts and blueprint-validator.mjs. Selection, phase scheduling, host profiles, registered platforms and the measured-scope rule are untouched."} -->
...
<!-- doc-review {"version":1,"fingerprint":"f4d97fde6429fa1608864b7e917ea9c65df7ffc752aacdd02dbf321850b559bb","dependencies":"docs/development/.reviews/README/isolated-candidate-completion.json","dependencyDigest":"afc50501a7b2b163da78cd4ad8fe126b49b0810da00863b8ba692728c2e597ee","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. Candidate capture, tier selection, window ownership, receipts, receipt reuse and landing admission are untouched, including the stacking rule this candidate itself followed to stack on the parametric-gear integration. The movers are scripts/manifest.json, which moved only by the elastic-cord invariant row, its rewritten guarantee and reviewed scope metadata, the merged integration's src/model/blueprint.mjs, catalog.mjs, geometry.mjs, environment.mjs, gear-geometry.mjs and boundaries.d.ts, the regenerated schema artefacts, and test/fixtures/reusable-rover.json. None is completion evidence or a rule about how evidence is captured."} -->
