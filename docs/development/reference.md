...
| independent-feedback-receipts | [validateFeedbackEnvelope](../../src/application/feedback-protocol.mjs), [openFeedbackStore](../../src/application/feedback-store.mjs), [mountFeedbackClient](../../src/application/feedback-client.mjs) | invariant-controls, verify-feedback-flow, verify-feedback-receipts, verify-feedback-lifecycle, verify-feedback-recovery |
