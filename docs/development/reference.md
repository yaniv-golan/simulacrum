...
| completed-draw-order | [createClock](../../src/application/clock.mjs), [mountWorkshopApp](../../src/application/workshop-app.mjs), [createWorkshopView](../../src/presentation/workshop-view.mjs) | verify-attachment-status, verify-spring-performance |
