...
<!-- doc-review {"version":1,"fingerprint":"16c77e002296496998c9fc4c905ee41148c0cd4ae3fe44dfd8b45b10e762a75d","dependencies":"docs/development/.reviews/architecture/overview.json","dependencyDigest":"bbf602b0dd3d86d990b53ce91e842c9334d514a7389aa646b355cbee04924aa2","disposition":"updated","rationale":"The complete overview identifies runtime-v1 for state/clock ownership, AGENTS for layer edges and validate-manifest as the canonical registry reader. Load Cell adds catalog, sampling, reaction and test entries under those existing owners; it creates no second registry or authority. The spring.10 package identity and completed-topology reaction changes change implementation dependencies rather than this owner map. Camera optical rendering and gallery owners remain presentation/application; Lamp electrical delivery remains simulation. Combined imports preserve the declared layer boundary. Revalidated after final thumbnail scheduling and spring witness closure: the new timer/DOM/cache owner and browser-only induction do not alter this section’s previously reviewed ownership, verification or evidence requirements. Integrated Authorable Scenes ownership matches environment descriptors, scene-library, scene-editor and document-proposal. Scene solids append after machine bodies and ground; they do not change Load Cell attachment identity or reaction ownership. Authored quaternions are preserved in documents and normalized for geometry. Scene editing exits mounted-camera ownership before tools activate. The added structural-failure limitation matches the current session phase: it checks finite bodies and conserved count/mass, without generic joint-capacity failure or automatic overload breakage. Load Cell measures reactions but does not add that failure mechanism; commanded release remains distinct."} -->
...
<!-- doc-review {"version":1,"fingerprint":"22326ded628b0aab7a6fd12829e57ea75efbd83761696bc8a5aed2e67ee16eea","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"6ff3bf7193de84c6654e2a696b36fb8651ddb08e2ca4b990ebd794f0faaa64c6","disposition":"still accurate","rationale":"workshop-view and scene-editor changed only how their dialogs compose a header row and × through the new presentation helper; the edit path (command, proposal, view, telemetry), utilityHost footer ownership, protected feedback dialogs outside the workshop root and part-help ownership are unchanged. The helper imports nothing and adds no new layer edge."} -->
