...
<!-- doc-review {"version":1,"fingerprint":"272a82a46243d5a2e25cbcd44820c070c4a1c917da63c5eb242d7460fbeaf142","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"de797ee8fb4f0fff67ccc655c5d819a70fce8691515632efafd6737d2e16e2dd","disposition":"still accurate","rationale":"The copy path still sends the ordinary insert command; the keep-view decision, the Shift-lift key mapping and the inspector's open-memory exclusion for the Connect & test disclosure live in the view, and command admission, compilation and history ownership are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"dd1fd2e6d5852bdddb30ecb8d928ddccaeb1cc7edb2f58550316303dfb7e76c5","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"e8ca7ede576bf8db1e90cd6b54157dd977c64ed69b1eaf20aafad4a99e6da78b","disposition":"still accurate","rationale":"connection-test.mjs reads the same connectionTestPaths result; the auto-open rule is a presentation decision over that read model and introduces no second source of connection truth."} -->
