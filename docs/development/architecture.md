...
<!-- doc-review {"version":1,"fingerprint":"b63fb203bc729407e526a987ca8b531738fe7cf13336c84c4c781cfc4acba3f0","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"440cadf37917a55f0f0a846fda9d468dff82e4720472cef49d22524e87df9dba","disposition":"still accurate","rationale":"The traced path is unchanged: a teeth or module edit is an ordinary parameter command validated against the generated schema, compiled through partPrimitives and the physics door as half extents and a mass, and drawn from telemetry. The changed dependencies are the two type-soundness fixes the boundary typecheck required: assertDimensionDefaults now guards that a gear row's teeth and module defaults are numbers, and the partPrimitives gear branch dispatches on the resolved facts (which exist exactly when the catalog declares the gear capability) instead of asserting non-null."} -->
...
<!-- doc-review {"version":1,"fingerprint":"fd04fee9deb9355ec938a54479577d3513ab1325e7ff314d86e9f824c985dce4","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"9164bfc8ec0cb4c201d31b0fa8a8d89160597ee85a081030cd3ab375b1bfba37","disposition":"still accurate","rationale":"The table's new row already names gearFacts as the owner of a gear's tooth count, module and derived radii, which is now also how partPrimitives dispatches. The changed dependencies are the two type-soundness fixes the boundary typecheck required: assertDimensionDefaults now guards that a gear row's teeth and module defaults are numbers, and the partPrimitives gear branch dispatches on the resolved facts (which exist exactly when the catalog declares the gear capability) instead of asserting non-null."} -->
...
<!-- doc-review {"version":1,"fingerprint":"85ada4f0e080e4b66a249f8ae86598686bf43e0d34be9f04030613282943a8fc","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"22e7e617656af36550708b1e8d991522fd7c9aebe55c48a8a57a54dc275ef2d4","disposition":"still accurate","rationale":"No sensor, channel, receiver or controller authoring path changed. The changed dependencies are the two type-soundness fixes the boundary typecheck required: assertDimensionDefaults now guards that a gear row's teeth and module defaults are numbers, and the partPrimitives gear branch dispatches on the resolved facts (which exist exactly when the catalog declares the gear capability) instead of asserting non-null."} -->
