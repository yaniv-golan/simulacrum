...
<!-- doc-review {"version":1,"fingerprint":"cc363062f50f8a2f5b43762f0579724e2cc099a1ed6c33f08433c3c189cbef63","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"d543d5c244e2e2f65b9dbc010bd14264d80101d271d86a33c60e3f092629af6f","disposition":"still accurate","rationale":"The sidecar and marker came out of the merge matching neither parent, so this is re-recorded. The dependencies this merge delta actually touched are src/presentation/part-mesh.mjs (the gear body drawn inward of the canonical solid) and src/presentation/part-help-content.mjs (one player-copy sentence extended to the bore). Both are presentation-only: the traced command-to-telemetry-to-view path, its layer ownership and its save/projection steps are unchanged, and the gear body is built in createPartMesh from resolved catalog facts."} -->
