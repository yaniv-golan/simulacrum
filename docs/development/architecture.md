...
<!-- doc-review {"version":1,"fingerprint":"7b2a26178322fce61a8ebffcc9085783a80aa56fb8fedf809ecc01c50d7101fe","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"61980d27b407435e10694b005e318d70dec417146056e8bbd84ef0e6af863c5f","disposition":"still accurate","rationale":"The traced path is unchanged: command, admission, compile, tick, telemetry, render. The cord enters as one more connection kind admitted through the same workshop-command boundary and compiled in src/model/connection-graph.mjs and src/model/tick.mjs; this branch's gear tooth rows are ordinary parameter commands and its spacing repair is issued as an ordinary surface-mount command from src/model/gear-geometry.mjs. No admission owner, compile stage or history ownership moved."} -->
...
<!-- doc-review {"version":1,"fingerprint":"19f2ad0cdc9414349c54c3a9a842fafda0e4ea33e8c2f767040d05bbc5f0d2cd","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"26ede62bc69b9d1127604beb52b635a0b3ae7c205f5ac1e350685e1e36581b41","disposition":"still accurate","rationale":"Both merged branches reused the canonical decisions this section lists rather than adding new ones: the cord reuses the existing segmented-connection and reason-code patterns beside src/model/rope.mjs, and the gear spacing repair reuses surface-mount admission instead of inventing a pose write. src/model/surfaces.mjs moved only by a type annotation. No second authority or duplicate decision record was introduced."} -->
...
<!-- doc-review {"version":1,"fingerprint":"e03bfddf603306d00b1858f3884795b90f4076971ffc3be4198f83aedec72be5","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"1efd7f297ce2735a0c754cee8ee53ed808deadb519c12f2917f31a4f93848935","disposition":"still accurate","rationale":"Neither branch added a sensor, a controller channel or an authoring frame. The cord is a connection with its own law reached through src/model/tick.mjs, and this branch's src/model/gear-geometry.mjs and src/model/gear-mesh.mjs changes are authoring and typing only. The shared sensing surfaces, their sampling boundary and the behavior-authoring ownership this section states are unchanged."} -->
