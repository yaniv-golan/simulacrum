...
<!-- doc-review {"version":1,"fingerprint":"79f010d0ad02bc6a0aa5abceefb882c789ef136a38024fd22d2c42dd201f8748","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"2ad281dffdf2d270baee0c9afdf070c2e7b42f1422e5abece43bc349cde6a9b5","disposition":"still accurate","rationale":"The traced path is unchanged: a teeth or tooth-size edit is an ordinary parameter command validated against the generated schema, compiled through partPrimitives and the physics door as half extents and a mass, and drawn from telemetry. The workshop-view change is that a generic numeric field takes its bounds and step from the parameter's own menu and sends nothing while it reports the value invalid, which moves no ownership: the schema remains the authority."} -->
