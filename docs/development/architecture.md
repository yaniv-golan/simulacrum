...
<!-- doc-review {"version":1,"fingerprint":"b7cfb564e2559eadc01337979ccee24217ae4473dde1a7a59834e2636a8584a3","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"25c19853019d3b3dce4188305b735489b9e2f7550d104914250edee4271b5e04","disposition":"still accurate","rationale":"Unchanged prose. The placing row and the surface panel still keep previews outside authored state and still commit through the same cursor-guarded place or surface-mount command. This candidate changes where the surface panel reads the state word that survives a throwing assessment (the shared placement vocabulary instead of a literal in the panel) and the row's stylesheet geometry, and adds no command, cursor, admission step or history effect. Step 2's ownership list and steps 3 to 5 hold as written."} -->
