...
<!-- doc-review {"version":1,"fingerprint":"d6f5b155a9ef1c9b7d43ca848772426445d56320205ed081984f936a611cb963","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"52ed63c43db0d34f72312208558c22f9783ce4494800092f2fce832762a91351","disposition":"still accurate","rationale":"Changed dependencies are src/presentation/workshop-view.mjs (Learn & examples renders one row per entry and the dialog's close collapses them) and src/presentation/workbench-content.mjs (LEARN_GROUPS supplies the row copy). The traced command-to-telemetry-to-view path and its ownership are unchanged; the rows are authored copy rendered by the same view."} -->
