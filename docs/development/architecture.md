...
<!-- doc-review {"version":1,"fingerprint":"6a5f36f587f59673bdec541e56a46b6b00abc98bd9cb9bf57bc09cae4cdd4b5a","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"cd8bf38003b21c954fb0b498532ed1434f44c7c6ada7f6cc8e324749b240f645","disposition":"still accurate","rationale":"Both new player actions follow the traced path exactly: the tooth-count control and the Space to mesh action keep preview and obstruction in presentation and commit through existing core commands (parameter and surface-mount), so step 2 turns input into ordinary commands, step 3 owns the one history transaction and step 4 admits placement geometry. No step's owner changed."} -->
...
<!-- doc-review {"version":1,"fingerprint":"084765f7dee21fe0ea14f8e9cd2945dde85a50efec9dbe7cad99f90d13d71bf2","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"0d4905282cccf7bc2cc7949085979b95d0a086c3604ddbf19f60fb529a4f4931","disposition":"updated","rationale":"Added the row naming meshSpacingRepair beside gearFacts as the owner of a mesh's required centre distance and of the one mount that can restore it, consumed by the gear mesh compiler and the selected mesh row. The transforms and connection-graph rows already covered the quaternion and mechanical-membership facts the new helper reads."} -->
...
<!-- doc-review {"version":1,"fingerprint":"a626001c8d987fc004bc9857a12ec444f648de7bbef60154a177d0d3124644b0","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"82f34271bdd4ae28a60e0da1bdbb41c80c4f2e12f520ce277c476fac08c247f5","disposition":"still accurate","rationale":"The gear helper is a dependency only through the shared model import graph; it reads no sensor, publishes no channel and takes no part in receiver arbitration or behaviour authoring. Nothing this section describes changed."} -->
