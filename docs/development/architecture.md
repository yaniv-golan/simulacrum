...
<!-- doc-review {"version":1,"fingerprint":"becead369f07cfd5d40d05d287c55d1d3d10f845b508493a2916c74fbf762b59","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"34c190647c7537917d5bffcd0d7248e3120b3f27072a7664b54b114d48b87352","disposition":"still accurate","rationale":"Re-recorded because the merge left the marker and sidecar matching neither parent. The dependencies this integration touched are src/presentation/workshop-view.mjs and src/presentation/workbench-content.mjs (Learn & examples became a bounded picker), src/presentation/part-mesh.mjs (the gear body drawn inward of the canonical solid) and src/presentation/part-help-content.mjs (one help sentence extended to the bore). All four are presentation-only: the traced command-to-telemetry-to-view path, the layer ownership in step 2 and steps 3 to 5 are unchanged, no command, cursor, admission step or history effect was added, previews stay outside authored state, and the gear body is still built in createPartMesh from resolved catalog facts."} -->
