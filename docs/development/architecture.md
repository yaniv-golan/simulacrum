...
<!-- doc-review {"version":1,"fingerprint":"08475b8e0a3ff12de07545106b15328a26a0fe43628c8984e65fa58d581abfdf","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"01ef2ce83899b9c49e92e0ebb4ffe02a06f4b935f13769a7c3b3b9ec2db21db1","disposition":"still accurate","rationale":"The numeric contact reader still supplies copied data through the sole physics door and session still assigns the interval inside integration timing. Callback error capture and scalar validation do not move ownership."} -->
...
5. [Session](../../src/simulation/session.mjs) owns stepping, checkpoint and completed publication. [Controllers](../../src/simulation/controllers.mjs) produce commands; [power](../../src/simulation/power.mjs) resolves circuits; the [physics door](../../src/simulation/physics/world.mjs) alone imports the physics library. Completed contact collection uses the numeric [contact reader](../../src/simulation/physics/read-contacts.mjs); session assigns the completed interval and includes collection in integration timing.
