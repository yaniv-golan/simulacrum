...
<!-- doc-review {"version":1,"fingerprint":"ae39df4935b39c93bd3a53f43287161cab3261c9fd2765c3b5eb91b959699ab4","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"3bf05cf9ebdd30d49dada175f8cf59c8265d8d061b032008d37c5bddc948a4d2","disposition":"still accurate","rationale":"Both player actions still follow the traced path: preview and obstruction stay in presentation and each commits through an existing core command. This pass only removed a duplicated constant, reworded a model message and dropped a repeated number from a read-out; no step's owner changed."} -->
...
<!-- doc-review {"version":1,"fingerprint":"690898ad3dfb0585cc0e25bc49dd84165c0a2e1cd27852058a7e4e08262b9fb1","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"f51d6bdf04f87ef707414584348413c31f8f7f8c703bb99722414294b69430e9","disposition":"still accurate","rationale":"The table's meshSpacingRepair row, recorded in the previous commit, now also covers the single owner of the authoring tolerance: gear-geometry exports SPACING_TOLERANCE and gear-mesh imports it, so the diagnosis and the repair read one number instead of two copies. The named owners are unchanged."} -->
...
| Gear mesh centre distance and the mount that restores it | [gearFacts](../../src/model/gear-geometry.mjs#symbol=gearFacts) / [meshSpacingRepair](../../src/model/gear-geometry.mjs#symbol=meshSpacingRepair)                                                                                                             | gear mesh compiler and the selected mesh row                                            |
...
<!-- doc-review {"version":1,"fingerprint":"f2c94ba16732f57424110545a7a581004c2833fe46d904e9e621328cf4d94d56","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"c971aa1d1d06edecd9b5e09938c559e25889d0d6ef74d980b0d8d6b0ab24f001","disposition":"still accurate","rationale":"The gear helper and the mesh compiler are dependencies only through the shared model import graph; neither reads a sensor, publishes a channel nor takes part in receiver arbitration. Nothing this section describes changed."} -->
