...
<!-- doc-review {"version":1,"fingerprint":"c51e54f14886d4e311dbe30df80ecadb92febe243c64417827584373d2b6c084","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"2041a701b0480c96d5c7142c20c0cdd8a692c0419fedbe175540416a1f39c8ee","disposition":"still accurate","rationale":"Parametric beam: the traced edit path is unchanged — the workshop view still turns input into ordinary commands, createWorkshop still admits a candidate and commits one history operation (the new resize refusal happens inside that admission before any blueprint change), validateBlueprint/placement admission/compileAssembly still derive configuration, and density remains material-owned; the beam's length reaches the renderer through the same partPrimitives resolver the inspector uses."} -->
...
<!-- doc-review {"version":1,"fingerprint":"9aac652931f94cbdf9ec86fe3976ea9bc955e6bbcf1021b0fd2a99286054d8fe","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"5f13e7b1f1c8270b78e4a77303dc5b0621f9a8cbc92d124c8311c99390a1003c","disposition":"updated","rationale":"Parametric beam: the canonical-decisions table gains a row for dimension edits keeping surface attachments in place (resizeMovesMount) and the length default equalling the canonical primitive (assertDimensionDefaults); the existing partPrimitives, resolveSurfaceEndpoint, transformGroup and search-vocabulary rows still name the right owners."} -->
...
<!-- doc-review {"version":1,"fingerprint":"f7840975e466adb7c7a81465da2270c1147f875827b7e91c3d25d34b75a59835","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"f1fffb61391c6be618733e460ba0ebc32534819987538485bb368bc0030d00a7","disposition":"still accurate","rationale":"Parametric beam: only catalog geometry, generated validator/types and surface pads changed; sensor and controller inspectors, learning workspace and their ownership described here are untouched."} -->
