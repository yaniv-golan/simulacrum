...
<!-- doc-review {"version":1,"fingerprint":"eba7b83900e743752bd31d2458dd29c7559783932c458809d31aead9c1aba3fd","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"d5fea9eb442924b9ecaf0a88f9fd71e9afe092faa3438d1e2058e561e40b5686","disposition":"still accurate","rationale":"The traced path is unchanged: command, admission, compile, tick, telemetry, render. The cord enters as one more connection kind admitted through the same workshop-command boundary and compiled in src/model/connection-graph.mjs and src/model/tick.mjs; this branch's gear tooth rows are ordinary parameter commands and its spacing repair is still issued as an ordinary surface-mount command, now from src/model/gear-mesh.mjs. No admission owner, compile stage or history ownership moved, and this section names neither module by path."} -->
...
<!-- doc-review {"version":1,"fingerprint":"c0077d5195154edd55b8103ec870d537317e28256fd7db4c33d890200b428454","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"7ee03316313fe123e7392711637aec16b534562b172bfb484fce72cb852a13d8","disposition":"updated","rationale":"The ownership row for the gear mesh centre distance now points meshSpacingRepair at src/model/gear-mesh.mjs. The function moved there unchanged because src/model/geometry.mjs reads gear facts and src/model/surfaces.mjs reads geometry primitives, so a repair reading mounts from gear-geometry closed a module cycle the structural gate refuses; gearFacts stays the pure numeric owner. The canonical decision the row records, that a mis-spaced mesh is repaired by editing the authored surface mount rather than by writing a pose, is unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"5cca15c7bf74b0d29131f1ef8cf67170e401c1472147f6d5aef2435ec30f2380","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"b760260fca4888541ea903018a87834e00d2bd33d5c154aabc57a9438aae0120","disposition":"still accurate","rationale":"Neither branch added a sensor, a controller channel or an authoring frame. The cord is a connection with its own law reached through src/model/tick.mjs, and this branch's gear changes are authoring plus the relocation of one helper between two model modules. The shared sensing surfaces, their sampling boundary and the behavior-authoring ownership this section states are unchanged."} -->
