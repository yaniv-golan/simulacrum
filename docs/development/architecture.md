...
<!-- doc-review {"version":1,"fingerprint":"3fa7dd91da606632f7871bbeb9a83175ca2fc6a160f8b743d9abedf40ae9b223","dependencies":"docs/development/.reviews/architecture/overview.json","dependencyDigest":"f4ebc31d75e2e850217624e9453e2c719132f7f4e4f842249f42f59e93851415","disposition":"still accurate","rationale":"The runtime contract gained an Elastic cords section, but the cord introduces no layer, no second physics door and no new import edge: it is a model module that compiles into the existing distributed elastic rows, so the overview's layer list and import rules hold unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"73e8b7423238ec430a12fa4b5ac33f47f0587f1217aae8d88229e38aa60e090e","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"6eac26871c97ab9daf764b6bd7c988445c2279ddab2d24ee9dfea3cfb5cd0b9d","disposition":"updated","rationale":"Updated: the authoring paragraph now names cord compilation beside rope compilation, so a reader tracing an edit finds the model owner that appends distributed massive nodes for an authored-stiffness elastic cord."} -->
...
<!-- doc-review {"version":1,"fingerprint":"55bc6bd1952a79e5209ea6d690707a623521cbcb1281e405dafe3ea61eb2d09c","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"1855698fcab5a07201283eb4d5df954668d556c2953611d1139f930497af056a","disposition":"updated","rationale":"Updated: the ownership table gained a row for elastic cord stiffness, damping and the shared elastic budget, owned by the new cord model and the existing nonlinear tensile law, so the canonical owner for those quantities is discoverable."} -->
...
<!-- doc-review {"version":1,"fingerprint":"b328ac20bc8c5e17108a4788ecaf590b11cf79457f9620a247f170181f42da29","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"28afbf1a5a523269348e10e89c8febb616a16a6cd7ab4c468cf8b102a46ef94b","disposition":"still accurate","rationale":"An elastic cord publishes no sensor reading, accepts no controller command and adds no phase. Sensor ownership, snapshot age and program authoring are unchanged; the cord's rows are solved in the existing integration-contacts phase beside the rope solve."} -->
