...
<!-- doc-review {"version":1,"fingerprint":"dcfd35f21d0a809e4dbd16fc6006d39a9e09a57974fa51b6d5519197c9bf0088","dependencies":"docs/development/.reviews/architecture/overview.json","dependencyDigest":"764159a255b41c109505ab8800a13afaeb5dacc2920d305b339adaf34f55532b","disposition":"still accurate","rationale":"The runtime contract change is the current save format number; the layer table, import rules, single-writer ownership and telemetry read model are untouched, and the new gear helper lives in the model and imports only the catalog."} -->
...
<!-- doc-review {"version":1,"fingerprint":"0af366b71f3a0521c3bfbb54cc55b3fd3d86b351bc2a0bfbfc2e52d9cab5616a","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"1985773cedafbd0c00a244899963b2fc7020603fc3020a6a9bf878b8e43bc2ce","disposition":"still accurate","rationale":"Unchanged prose, re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so docs:prepare reports the whole dependency set as changed. The dependencies this integration actually moved are src/presentation/workshop-view.mjs (the merged dialog rows plus this tip's parameter-field range and validity guard), and src/presentation/part-placement.mjs, src/presentation/surface-controls.mjs, src/presentation/placement-lifecycle.mjs and src/presentation/workbench-content.mjs (the merged placement cues and placing row). The traced path and its layer ownership are unaffected: a teeth or tooth-size edit is still an ordinary parameter command validated against the generated schema, compiled through partPrimitives and the physics door as half extents and a mass, and drawn from telemetry. The field's refusal is presentation reporting its own control's validity and restoring the authored value; it sends no command and moves no ownership, and the schema remains the authority. The placement cues are preview drawing that writes no authored state."} -->
...
<!-- doc-review {"version":1,"fingerprint":"2c0911027ffa37f24313cc6822ca2129140ccfbdb59b48191ed34364c6537136","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"acb9c501cc337266e29a34b0fc9d359e45c6f2339a4d04907ba2fb8cfe696950","disposition":"still accurate","rationale":"The table's gearFacts row already names the owner of a gear's tooth count, module and derived radii; the catalog now also refuses a gear row that does not author both defaults, which enforces that ownership rather than moving it."} -->
...
<!-- doc-review {"version":1,"fingerprint":"e2d6e1469d5777d85449a58ecad25cdcee925bd22db6fa686dfd5c31eecc5312","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"d21a18007382a858840c32cac580281f5f97979c00c6bffc2d119c4f5edd49e8","disposition":"still accurate","rationale":"No sensor, channel, receiver or controller authoring path changed; the changed dependencies are the catalog gear-row rule, the regenerated validator and the partPrimitives gear branch."} -->
