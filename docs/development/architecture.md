...
<!-- doc-review {"version":1,"fingerprint":"a88701d3a1c0fce544e17e45f2a6854f05ad0807f83024a040e3e983064be823","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"82207f2cb07e1e092c04003b64df6d44f1055ba6e9bb489f27d7d9d8d7e3c741","disposition":"still accurate","rationale":"Phased browser scheduler landing (tooling-tier-wall-clock on main 9157fbd): workshop-view.mjs gained a loopTicks counter in draw() exposed through readInteractionState().rendering for the renderer-liveness probe; the edit trace (model → simulation → telemetry → presentation) and its ownership are unchanged."} -->
