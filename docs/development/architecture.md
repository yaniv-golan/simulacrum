...
<!-- doc-review {"version":1,"fingerprint":"48040738f34f7657943079cd9f799668f23739be0f9ecffe452162bbbc7d72c0","dependencies":"docs/development/.reviews/architecture/trace-an-edit.json","dependencyDigest":"4a1c35774b90202711adaccde7cf0c1033b9d13c5920b1ed4b97c9267a290dbb","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. The traced path from command to telemetry is unchanged. The movers are the merged integration's gear work -- src/model/gear-geometry.mjs, gear-mesh.mjs, catalog.mjs, geometry.mjs, environment.mjs, boundaries.d.ts, src/presentation/part-mesh.mjs, part-search.mjs, part-help-content.mjs and port-wording.mjs -- together with src/model/assembly.mjs and blueprint.mjs, src/presentation/workshop-view.mjs and the regenerated schema artefacts. Each is a step this section already names; none moved a step, an owner or a phase."} -->

1. [Workshop application](../../src/application/workshop-app.mjs#source) composes the DOM view, clock and core.
2. [Workshop view](../../src/presentation/workshop-view.mjs#source) turns player input into ordinary commands. The [parts browser](../../src/presentation/parts-browser.mjs#source) owns discovery, [search vocabulary](../../src/presentation/part-search.mjs#source) ranks available parts, and [part placement](../../src/presentation/part-placement.mjs#source) confirms click, touch and drag proposals through cursor-guarded placement, delegating mounting geometry and controls to the existing surface owner. [Surface controls](../../src/presentation/surface-controls.mjs#source), their [placement lifecycle](../../src/presentation/placement-lifecycle.mjs#source), and [mirror controls](../../src/presentation/assembly-mirror.mjs#source) keep previews outside authored state. [Spring controls](../../src/presentation/spring-controls.mjs) submit bounded parameter edits and explain rejected drafts. [Rope controls](../../src/presentation/rope-controls.mjs) author a tensile connection between two surface attachments; [rope compilation](../../src/model/rope.mjs) appends distributed massive nodes, and [cord compilation](../../src/model/cord.mjs) appends the same shape for an authored-stiffness elastic cord. Assembly capture and placement forms also remain transient; their accepted edits use the same core.
...
<!-- doc-review {"version":1,"fingerprint":"7ab7cc6562704e632f5fc68ec4ae52cf7fbae7a48fd8c242fbbb62347d895d6c","dependencies":"docs/development/.reviews/architecture/reuse-canonical-decisions.json","dependencyDigest":"0c40080fbe59a9d636f54063066f84383ee7d63499b0d47ced82caab686b0904","disposition":"updated","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Updated: the merged parametric-gear integration added a canonical decision row stating that gear tooth count, module and every radius derived from them are owned by gearFacts in src/model/gear-geometry.mjs, consumed by partPrimitives, the gear mesh compiler and the part builder. That is the authority statement behind its src/model/boundaries.d.ts change, which reduced the catalog gear declaration to stiffness and damping so the dimensions are authored parameters rather than catalog constants. The other movers are catalog.mjs, geometry.mjs, gear-mesh.mjs, environment.mjs, part-search.mjs, part-help-content.mjs, port-wording.mjs, assembly.mjs, blueprint.mjs and the regenerated schema artefacts. The cord side adds no canonical decision row: a cord's stiffness, damping and mass owners were already covered by the distributed elastic entry."} -->
...
| Gear tooth count, module and derived radii            | [gearFacts](../../src/model/gear-geometry.mjs#symbol=gearFacts)                                                                                                                                                                                              | partPrimitives, gear mesh compiler and part builder                                     |
...
| Elastic cord stiffness, damping and shared budget     | [cord model](../../src/model/cord.mjs), the same [nonlinear tensile law](../../src/simulation/physics/law/rope.mjs)                                                                                                                                          | completed rows in the distributed elastic read model                                    |
...
<!-- doc-review {"version":1,"fingerprint":"4f3d7e6d0351684edea33dfc282bc030712bc655e3c2687763693d36771db104","dependencies":"docs/development/.reviews/architecture/shared-sensing-and-behavior-authoring.json","dependencyDigest":"a29c218779deaeeb5d21fc7843f9b6731ea6ce5ad0da4e25d65710d8830ac9a6","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. Shared sensing, the sensor snapshot age rule and the authoring surfaces for behavior are unchanged, and the cord adds no sensor, no controller input and no authored behavior: its damper is not visible to power allocation, as the rope's is not. The movers are the merged integration's src/model/gear-geometry.mjs, gear-mesh.mjs, catalog.mjs, geometry.mjs, environment.mjs, boundaries.d.ts and src/presentation/port-wording.mjs, plus src/model/assembly.mjs, blueprint.mjs and the regenerated schema artefacts. A gear row's dimensions becoming authored parameters changes no sensing or behavior-authoring owner."} -->
