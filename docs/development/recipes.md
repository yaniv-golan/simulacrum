...
<!-- doc-review {"version":1,"fingerprint":"6846165a71972af46a60ea5ac79070199e8fcb57450a719523238e6f465a3608","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"644aaa6db927ffe4ff02f0a7b1d133f686245a44a2cd4180c44ae7c48f53961f","disposition":"still accurate","rationale":"Follow-up to the diagnosed retry on main 38f6de8: refused-phase rows visible to --after, the every-commit format gate, the prettier fix. No simulation, physics-door, power, checkpoint or contact behavior changed; the dependency drift is verification tooling (refused-phase retry rows, the format gate) and the documentation describing it. The recipe's analytical, conservation and qualification requirements are unaffected."} -->
