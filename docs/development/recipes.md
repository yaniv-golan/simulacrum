...
<!-- doc-review {"version":1,"fingerprint":"c44b0aa2c083270975595055c79f9b92c9c32ee1485ee32d362b2422a347fd08","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"59afcc4a7099fc3411f4d7b4bc559a2e5ef998c459ddd6f80d54a4bb5338f28c","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. The physics recipe, its narrow-door rule, its law layer rule and its analytical and conservation evidence requirements are unchanged, and this candidate's cord rows were added through them: one distributed unilateral elastic law solved beside the rope in integration-contacts, inside the same single integration. This section's dependency set is the widest in the tree, so it sees nearly every file the merge touched: the merged integration's gear model, presentation and browser case files, this candidate's src/simulation and src/model cord path, the regenerated schema artefacts, scripts/manifest.json, the amended docs/contracts/runtime-v1.md, and test/cord-domain-corners.test.mjs, whose new assertion measures that an undamped cord at the stiffest corner settles through ropeNumericalLossJ and never through damping work."} -->
