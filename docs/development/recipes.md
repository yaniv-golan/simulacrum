...
<!-- doc-review {"version":1,"fingerprint":"70d1b569654a3dd3cc16d936d137d69b758ed7e744407b17187cf00090e3e496","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"b1f98a6b139b5de5a5406cefbe1d5469854a0c2851d7159a3da2df26ea7eb174","disposition":"still accurate","rationale":"Its dependencies changed only through the feedback sync landing (scripts/playtest/sync-feedback.mjs: a scheduled read-only local copy of hosted feedback with attachments and referenced recording exports; manifest gained the feedback-sync-read-only invariant with its controls and regenerated consumer lists for download.mjs and cloud-store.mjs; reference.md regenerated; the in-memory CaptureStore fixture moved to test/fixtures/capture-store-memory.mjs) and the corresponding docs; physics ownership, the simulation door, law inputs, the named invariants and the recipe's verification steps are unchanged and were re-read against src/simulation at this revision."} -->
