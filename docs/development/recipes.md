...
<!-- doc-review {"version":1,"fingerprint":"623e3112a16d10f0467e6efd735177e6edb73f13751a23c564c0b816dc547d3f","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"7248b6138154bd4c299cfe2e46e56057c2cbaa99413fe3c97cf9d9d6cc07a460","disposition":"updated","rationale":"The merged section carries the performance branch guidance (cached door reads retired on every physical mutation, native response typed views, finite body sample constructor, Uint8Array replay anchors with plain exported bytes, power completion copying only modified motor records with late-failure retry, frozen-run projection comparison, blueprint reference fast path and reusable scene preparation) on top of main's unchanged solver, step-order and qualification text. Verified against power.mjs: step validates with { settled: false, trustedShape: true } and completion validates the completed values plus main's settled circuit ledger with trustedShape only; restore still performs full admission. Mechanical audio reads completed numeric motion through an application adapter and writes no physics state."} -->
