...
<!-- doc-review {"version":1,"fingerprint":"681aace42b237405b84065f406e383a84867aa2530555bb4d6485bcaea419843","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"953ef6b6b2f88aa0bd15d638cd304ae16994435e6b6430d6a9271ddd941807ef","disposition":"still accurate","rationale":"Hosted profile (claude/hosted-profile) stacked on the live-wait branch tooling-niced-launch-liveness 3a50c9e (both on main 421a2b1): the changed dependencies reach this section only through its evidence and CI scripts: ci.yml routing and job budgets, ci-verification/ci-release dispatch-only release runs, ci.mjs budget, merge-comparison's NOT_EVALUATED listing, verify-browser-suite/verify-candidate preflights, rules.mjs profile state line, and the AGENTS.md/README/playtesting sentences. No physics law, fixture, evidence script assertion, contact or reset policy changed; the recipe's analytical, conservation and qualification requirements are unaffected."} -->
