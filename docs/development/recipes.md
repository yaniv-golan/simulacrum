...
<!-- doc-review {"version":1,"fingerprint":"421e9ef83f59dd6cde51bf429f9503ffa11d6a9e3d0c89c670ad85ba4568e411","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"6a7e615cfa789fafb373ad3738de45cda6cd9f80befcebc2c05c1c401703e04d","disposition":"still accurate","rationale":"Its dependencies changed only through the release identity record (identityFiles export in candidate.mjs sharing the candidate inventory; prepare-release recording files, installed digest, installedAt and runtime identity in source.json with caches redirected and the digest re-verified after the tier; its control registered under release-verification-single-pass) and the corresponding doc sentence and tests; physics ownership, the simulation door, law inputs, the named invariants and the recipe's verification steps are unchanged and were re-read against src/simulation at this revision."} -->
