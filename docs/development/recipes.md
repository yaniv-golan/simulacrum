...
with mobility whatever the authored size, while the island returns it through the bearings -
the two figures answer different questions and neither substitutes for the other. Dependency
