...
<!-- doc-review {"version":1,"fingerprint":"17b4b87c29a3bf5375aef7d547840a5ed6a9ec5b23c25686bbfea5ad5caa6203","dependencies":"docs/development/.reviews/recipes/change-an-interaction.json","dependencyDigest":"91eac21d481e9d890ba58eb348a22a0cfcd47c66182339b9bb602e9b74c18a84","disposition":"still accurate","rationale":"Dependencies changed only through the merged frozen tip and the release-path tooling change (on the merged base (land-script 9c4e08d0: hosted-check-waits' wait scale/live slice/row budget, merge --stack, the land script and the assessment split) the release-path tooling change stands: FINAL_PHASES shared between verify-final and the package tests; the bounded launch wait budget recorded as budgetMs and stripped from leaves beside the hosted wait variables; the printed refusal with offenders; prepare-release's 300 s release wait, named refusal, releaseEnvelope and dryCheckRelease (release:prepare --dry-check); verify-host.mjs (npm run verify:host) on the admission's own code with describeOwner now carrying the stacked-on branch; the manifest guarantee and two controls of release-verification-single-pass); this recipe's steps, owners and verification commands are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"4bb8d84356b6d5b148b96017eb6374cac3ae48b97173c9b030f8b4732cab2c14","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"8b742036de809bc9c440f201b898c235738e15e1299ae1087ec4b4ba78739cd9","disposition":"still accurate","rationale":"scripts/manifest.json changed only by the accepted scope review refreshing consumerSourceHash on 16 browserReviewMetadataScopes rows (consumer closures moved because prepare-release.mjs/release.mjs changed and verify-host.mjs joined as a consumer); no reads, consumers, checks or guarantees changed beyond the release tooling change already reviewed for this section: Release-path tooling, tests and policy documents changed (on the merged base (land-script 9c4e08d0: hosted-check-waits' wait scale/live slice/row budget, merge --stack, the land script and the assessment split) the release-path tooling change stands: FINAL_PHASES shared between verify-final and the package tests; the bounded launch wait budget recorded as budgetMs and stripped from leaves beside the hosted wait variables; the printed refusal with offenders; prepare-release's 300 s release wait, named refusal, releaseEnvelope and dryCheckRelease (release:prepare --dry-check); verify-host.mjs (npm run verify:host) on the admission's own code with describeOwner now carrying the stacked-on branch; the manifest guarantee and two controls of release-verification-single-pass); re-recorded after merging the frozen tip, whose own changes (browser wait scaling, --stack, land script, assessment split) carry their own reviews and do not alter this section's description."} -->
...
<!-- doc-review {"version":1,"fingerprint":"720d83a9ac22fd019d275bc2bb9bf6ecc5de124e0d0f7c4f3860bd9770457ecc","dependencies":"docs/development/.reviews/recipes/change-multi-part-authoring.json","dependencyDigest":"62e807ec814b044892fc58386a0a09c95ef7a1eb25b996eb7ff1f2ce05f01b6e","disposition":"still accurate","rationale":"Dependencies changed only through the merged frozen tip and the release-path tooling change (on the merged base (land-script 9c4e08d0: hosted-check-waits' wait scale/live slice/row budget, merge --stack, the land script and the assessment split) the release-path tooling change stands: FINAL_PHASES shared between verify-final and the package tests; the bounded launch wait budget recorded as budgetMs and stripped from leaves beside the hosted wait variables; the printed refusal with offenders; prepare-release's 300 s release wait, named refusal, releaseEnvelope and dryCheckRelease (release:prepare --dry-check); verify-host.mjs (npm run verify:host) on the admission's own code with describeOwner now carrying the stacked-on branch; the manifest guarantee and two controls of release-verification-single-pass); this recipe's steps, owners and verification commands are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"cd3757bab4ee014fab7ce0cbf0f25fde25f46dea43019b389ad5d3bb07aea1d2","dependencies":"docs/development/.reviews/recipes/change-a-presentation-overlay.json","dependencyDigest":"36ac6a5570c3cb7e287994106d0a6c287dfd0e7329dda0f0aab4e7f46dea7bc4","disposition":"still accurate","rationale":"Dependencies changed only through the merged frozen tip and the release-path tooling change (on the merged base (land-script 9c4e08d0: hosted-check-waits' wait scale/live slice/row budget, merge --stack, the land script and the assessment split) the release-path tooling change stands: FINAL_PHASES shared between verify-final and the package tests; the bounded launch wait budget recorded as budgetMs and stripped from leaves beside the hosted wait variables; the printed refusal with offenders; prepare-release's 300 s release wait, named refusal, releaseEnvelope and dryCheckRelease (release:prepare --dry-check); verify-host.mjs (npm run verify:host) on the admission's own code with describeOwner now carrying the stacked-on branch; the manifest guarantee and two controls of release-verification-single-pass); this recipe's steps, owners and verification commands are unchanged."} -->
