...
<!-- doc-review {"version":1,"fingerprint":"80951aadf5c45a647a5b0b84cafce3fcb13a5971180d7681d6bde0fc1967385d","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"c5bb2c7e031ae09fa4273cf995669152214c7ee4d0dd9aef323bbe83a61674af","disposition":"still accurate","rationale":"Decision 45-B closure amendment on bed79d1a: the candidate-after fixture now forces the --when-quiet poll interval to 20 ms (six expiry cases at the real 5 s cadence put the E2E file past the tier's 30 s unit budget; the scripted host, not the cadence, is what the cases assert). Test-only; the recipe's steps and what this section explains are unchanged."} -->
