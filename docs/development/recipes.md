...
<!-- doc-review {"version":1,"fingerprint":"c447c19aa8b8b5f613ad5233933c60168c8c2a9cce808095539902c086abe80d","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"65a216771bf14ae104a1874800204f9bf9a74f0d3742ba046d468fc7169ef480","disposition":"updated","rationale":"Updated because merging candidate 2 added a paragraph to this section: an elastic cord is a second connection compiled into the same distributed rows, authoring its own end-to-end stiffness and damping in the measured 1-300 N/m and 0-100 N s/m ranges while material and diameter own only the distributed mass, adding no law because the tension-only Kelvin element it needs is the existing rope law and duplicating it would put one law under two owners. That arrives through the existing narrow door in src/simulation/physics/world.mjs with its own determinism, energy and corner tests, so the door's ownership, the single 1/120 s integration order, the no-live-physics-object rule and the analytical and conservation evidence this recipe requires are all unchanged. This branch's own obligations in the section are untouched and still hold: one elastic constant serving a range of authored sizes owes evidence at the ends of that range, the per-tick energy ledger rather than a steady work balance is what can support a dissipation claim, and a work residual taken across a kinematic mesh is algebraically zero before any physics happens. test/gear-bounds.test.mjs, test/fixtures/gear-bounds.mjs and scripts/measure-gears.mjs carry that evidence and the manifest registers its four controls. No law, tick order, integration or physics-door shape moved; the wide flagged dependency list is this recipe's declared closure, not behavior this section states."} -->
