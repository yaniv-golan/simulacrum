...
<!-- doc-review {"version":1,"fingerprint":"da57a09a709a2f70cff4e518aa8a4ec8b7f7bf8d83703414a298df22ada94462","dependencies":"docs/development/.reviews/recipes/add-or-extend-a-part.json","dependencyDigest":"66876682ce1f2048a1f37e7e40d1a8aa3e48c8ca27e44df669f7d9faa243a69c","disposition":"updated","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Updated: the merged parametric-gear integration replaced the two fixed-ratio spur gear rows with one row whose tooth count (12-36) and module are ordinary authored parameters, and this section now records that gearFacts in src/model/gear-geometry.mjs is the only place they become a pitch or collider radius, that the gear branch in partPrimitives dispatches on whether that helper resolves exactly as the length and diameter branches dispatch on a parameter name, and that assertDimensionDefaults refuses by name at load a gear row whose defaults do not reproduce its canonical primitive. It also records that equal tooth size and centre distance are per-edge diagnostics stamped on the connection row, emitting no joint and never refusing a parameter edit, while mesh admission still depends on authored topology alone. Its other movers are catalog.mjs, geometry.mjs, gear-mesh.mjs, environment.mjs, boundaries.d.ts, blueprint.schema.json, fixtures/gear-lift.mjs, part-search.mjs, part-help-content.mjs, the regenerated schema artefacts and the gear tests. The cord adds no part, so this recipe needs nothing from this candidate."} -->
...
<!-- doc-review {"version":1,"fingerprint":"5782db43aac5b3debd7b146beb0b4ec244817cc27fcd83c686daf907573baef0","dependencies":"docs/development/.reviews/recipes/add-a-command.json","dependencyDigest":"2fa2a0f77655eac8fcbff507cde82f79d197ab8577304d4216fa9c62106d60d4","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. The command recipe, its schema and compiler steps and its required tests are unchanged. The movers are the merged integration's gear model files -- gear-geometry.mjs, gear-mesh.mjs, catalog.mjs, geometry.mjs, environment.mjs, boundaries.d.ts -- plus assembly.mjs, blueprint.mjs, the regenerated schema artefacts and two existing command suites, test/scene-preservation.test.mjs and test/surface-mount.test.mjs. This candidate's own cord command was authored by following this recipe unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"e89adabb1d68beec03554d081dfd389e5ba29b6bc152101f3abb37495681d05c","dependencies":"docs/development/.reviews/recipes/change-an-interaction.json","dependencyDigest":"e2ab0165a5b083b84ff94342a282c70a4508c9845b5a4a31b5fc6ce788ce0180","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. The interaction recipe and the surfaces it names are unchanged. The movers are the merged integration's gear model and presentation files -- gear-geometry.mjs, gear-mesh.mjs, catalog.mjs, geometry.mjs, environment.mjs, boundaries.d.ts, part-search.mjs, part-help-content.mjs and port-wording.mjs -- plus assembly.mjs, blueprint.mjs, the regenerated schema artefacts and src/model/messages.mjs, which gained this candidate's cord explanations and the merged integration's gear tooth-size message. New explanations are not a change to how an interaction is changed."} -->
...
<!-- doc-review {"version":1,"fingerprint":"e238ef3b35066ef8c68ef059abe978fb211e7e3dd12790e77da95942fab27f6c","dependencies":"docs/development/.reviews/recipes/add-a-diagnostic.json","dependencyDigest":"096890a368c898e46ca7ef01ccb9830f67d66bc66fc9e1d29e3ef757da62a4e6","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. The diagnostic recipe, its telemetry-only rule and its registration steps are unchanged. Every mover is the merged integration's gear model set -- gear-geometry.mjs, gear-mesh.mjs, catalog.mjs, geometry.mjs, environment.mjs, boundaries.d.ts -- plus assembly.mjs, blueprint.mjs and the regenerated schema artefacts. No diagnostic was added, removed or re-owned."} -->
...
<!-- doc-review {"version":1,"fingerprint":"a785f814671e31975ca0bbf026eb0640b06479747188e27a23970a707256f13a","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"19341a0b34abb5d107c53ef27e0507a51867fd6f5aad8b8439bdf415db17b50b","disposition":"still accurate","rationale":"Unchanged prose; this section was not revised, so the disposition is still accurate rather than updated. docs/contracts/runtime-v1.md is the only changed dependency. The merged parametric-gear integration bumped the blueprint save version to 4 at the envelope, time-scale and slide sentences but left two sentences in Saves and checkpoints reading version 3, so the contract contradicted itself. This closure repairs those two: the checkpoint sentence now separates the session checkpoint version, which remains 3 as captureAnchor in src/simulation/session.mjs still writes it, from the blueprint save version 4, and the environment-admission sentence now reads version 4. The elastic cord energy paragraph also gained the scope of its row ledger. That last addition is the only one this recipe is sensitive to: it records that the distributed elastic row ledger accounts for the cord rows alone and that the remainder of a measured energy drop leaves through the resolved spherical anchors and the appended node chain's own solve, which the rows neither measure nor claim. It sets the scope of the conservation evidence this recipe demands without changing the narrow-door rule, the law-layer rule or the evidence requirements themselves."} -->
...
<!-- doc-review {"version":1,"fingerprint":"019865d26d89ab82acbed7a0475cc30f2509d304cdf1fba0fd285d1ab8615b2e","dependencies":"docs/development/.reviews/recipes/change-multi-part-authoring.json","dependencyDigest":"99ba5d0ac7b80233b1179da3e0fd0c0fe89ca56f864b766bb751666aae5dcfbc","disposition":"still accurate","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Unchanged prose. Subassembly capture, instantiation and the rule that instantiation copies authored selections rather than deriving them are unchanged, and the cord follows it: a copied reusable graph preserves the authored material and numeric plant. The movers are the merged integration's gear model set, assembly.mjs, blueprint.mjs, blueprint.schema.json, messages.mjs, the regenerated schema artefacts and test/fixtures/reusable-rover.json."} -->
...
<!-- doc-review {"version":1,"fingerprint":"7b43ff70110fa8b57b2b794aa09ed62fffdf1a0bac5f306c6aebd2b60482f408","dependencies":"docs/development/.reviews/recipes/change-a-presentation-overlay.json","dependencyDigest":"60c70ebb3ea2f30e5d208174057e32915b32e3d0ebe1fe479de7a20d11f86143","disposition":"updated","rationale":"Re-recorded because the merge left this section's marker and its dependency sidecar matching neither parent, so the previous receipt was malformed rather than merely stale. Updated: the merged parametric-gear integration added the rule that a generic numeric setting takes its bounds and step from parameterInputRange in src/presentation/parameter-input.mjs, which narrows both to a parameter's enum when it declares one, and that no parameter edit is sent while the field reports the value invalid. That is the owner behind its new presentation module. Its other movers are part-mesh.mjs and port-wording.mjs, the gear model set, assembly.mjs, blueprint.mjs, the regenerated schema artefacts and test/gear-view.test.mjs. The cord draws nothing: no surface renders a cord yet, so this candidate adds no overlay and needs no rule here."} -->
