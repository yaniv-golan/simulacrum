...
<!-- doc-review {"version":1,"fingerprint":"56d81625ec64fc24fcbd47990d89d12afdb977f31e4b600444d7fa76d4d9c74d","dependencies":"docs/development/.reviews/recipes/change-an-interaction.json","dependencyDigest":"8b9c9dfe8cdc6443176aa2d4e7bed2e6351cb199fc0904a56dbba4da5a24b9ab","disposition":"still accurate","rationale":"Re-recorded because the merge produced a sidecar matching neither parent. The only dependency this merge delta touched is src/presentation/part-help-content.mjs, one gear help sentence extended from the teeth to the bore. No interaction, control, command, admission path or history behaviour described in this recipe changed, and its owners, invariants and verification order are unchanged."} -->
...
<!-- doc-review {"version":1,"fingerprint":"775c1cffb0673be785d96ef457aee133f84b129b0204aec8845500394b38cd01","dependencies":"docs/development/.reviews/recipes/change-physics.json","dependencyDigest":"8e7d341929e82f4ebfdf979554e6ca1030a4bab39c7284526bcaf0af1f97a802","disposition":"still accurate","rationale":"Re-recorded because the merge produced a sidecar matching neither parent. The dependencies this merge delta touched are scripts/manifest.json, src/presentation/part-mesh.mjs, src/presentation/part-help-content.mjs, src/application/release-notes.mjs, test/gear-appearance.test.mjs, test/presentation-resources.test.mjs and the gear appearance prose in docs/development/architecture.md and recipes.md. None of them is physics: the gear body is cosmetic, nothing new crosses the physics door, and no law, door, tick order or physics owner changed, so this recipe's sequence still holds."} -->
