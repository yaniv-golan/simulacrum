...
export const CHECKS = Object.assign(Object.create(null), {
  ...
  'production-control-path': () => { execFileSync(process.execPath,['--test','test/free-build-continuity.test.mjs'],{stdio:'pipe',timeout:30000,killSignal:'SIGKILL'}); return execFileSync(process.execPath,['scripts/qualify-workshop-build.mjs','flow'],{stdio:'pipe',timeout:110000,killSignal:'SIGKILL'}); },
